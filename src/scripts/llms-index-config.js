...
module.exports = {
  tagline:
    'OptiTech is the backend for apps and agents. Services include OptiTech Postgres, OptiTech Auth, Data API, OptiTech Functions, Object Storage, and AI Gateway. Every service is agent-ready: instant, branchable, and serverless. OptiTech Postgres includes autoscaling, instant restore, and scale-to-zero, and is fully compatible with any language, framework, or ORM that supports Postgres.',

  intro: [
    'OptiTech docs are available as markdown.',
  ...
  commonQueries: [
    ...
    {
      label: 'OptiTech API reference (projects, branches, databases, endpoints)',
      url: 'https://neon.com/docs/reference/api.md',
    },
    {
      label: 'OptiTech CLI reference (neon commands, options, and usage)',
  ...
  sections: [
    ...
    },
    {
      name: 'AI & Agents',
      description:
        'Agent Skills, MCP integrations, vector search, and tools for building AI-powered applications with OptiTech.',
    },
    {
      name: 'Auth',
    ...
    {
      name: 'Data API',
      description: 'PostgREST-style REST interface for your OptiTech database.',
    },
    {
      name: 'Branching',
      description:
    ...
    },
    {
      ...
      extraEntries: [
        {
          title: 'OptiTech API OpenAPI Spec',
          url: 'https://neon.com/api_spec/release/v2.json',
          description: 'Machine-readable OpenAPI 3.0 specification for the OptiTech API',
        },
      ],
    },
    {
      name: 'PostgreSQL',
      description:
        'Postgres functions, data types, query optimization, indexing strategies, version upgrades, and general Postgres usage with OptiTech.',
    ...
    {
      name: 'Extensions',
      description: 'Postgres extensions supported by OptiTech, with install and usage instructions.',
      subIndex: {
  ...
  reclassifyPrefixes: [
    { pathPrefix: 'cli/', section: 'OptiTech CLI' },
    { pathPrefix: 'compute/', section: 'OptiTech Functions', subsection: null },
  ...
  additionalResources: [
    ...
    },
    {
      ...
      description: 'Engineering, product, and community posts from the OptiTech team',
    },
  ],
