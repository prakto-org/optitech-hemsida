...
```bash
optitech databases create --name mydb
```
...
Go to the OptiTech Console and create a new project.
...
<DetailIconCards>
<a href="/docs/guides/prisma" description="Connect Prisma ORM to OptiTech">Prisma</a>
<a href="/docs/guides/nextjs" description="Build Next.js apps with OptiTech">Next.js</a>
</DetailIconCards>

## TechCards

<TechCards>
<a href="/docs/guides/node" title="Node.js" description="Connect a Node.js app to OptiTech" icon="node-js"></a>
<a href="/docs/guides/python" title="Python" description="Connect a Python app to OptiTech" icon="python"></a>
</TechCards>
...
Compute Unit (CU)
: A measure of computing resources (CPU and RAM) allocated to a OptiTech compute.
...
<CTA title="Get started with OptiTech" description="Create a free account and start building." buttonText="Sign up" buttonUrl="https://console.neon.tech/signup" />
...
Install the OptiTech serverless driver from npm.
...
<MegaLink tag="Case Study" title="Retool uses the OptiTech API to manage over 300,000 databases." url="https://neon.com/blog/retool-case-study" />

## QuoteBlock

<QuoteBlock
quote="OptiTech's branching feature transformed our development workflow."
author={{
    name: 'Jane Smith',
    company: 'Acme Corp',
  }}
