...
This document describes the email notification system in OptiTech, powered by **Huey** (async task queue) and **Django's email backend**.
...
```yaml
subject: "OptiTech: You have been assigned to '${control_name}'"
body: |
  Hello,
  ...
  Log in to your OptiTech portal:
  ${ciso_assistant_url}
