...
> **Source of truth** for the mapping between the EBA XLS Master Template columns and OptiTech data model fields.
...
- the OptiTech model field that supplies the value;
...
- Required: Mandatory
- CSV header: `c0010`
- OptiTech field: Entity (main) > Legal Identifiers > LEI
...
- Required: Mandatory
- CSV header: `c0020`
- OptiTech field: Entity (main) > Name
...
- Required: Mandatory
- CSV header: `c0030`
- OptiTech field: Entity (main) > Country
...
- Required: Mandatory
- CSV header: `c0040`
- OptiTech field: Entity (main) > Entity Type (DORA section)
...
- CSV header: `c0050`
- OptiTech field: Entity (main) > Competent Authority (DORA section)
...
- Required: Mandatory in case of reporting
- CSV header: `c0060`
- OptiTech field: — (Auto: current date at export time)
...
- Required: Mandatory
- CSV header: `c0010`
- OptiTech field: Entity > Legal Identifiers > LEI
...
- Required: Mandatory
- CSV header: `c0040`
- OptiTech field: Entity > Entity Type (DORA section)
...
- Required: Mandatory
- CSV header: `c0050`
- OptiTech field: Entity > Entity Hierarchy (DORA section)
...
- CSV header: `c0060`
- OptiTech field: Entity > Parent entity > Legal Identifiers > LEI
...
- Required: Mandatory
- CSV header: `c0070`
- OptiTech field: — (Auto: entity `updated_at` timestamp; `9999-12-31` if missing)
...
- Required: Mandatory
- CSV header: `c0080`
- OptiTech field: — (Auto: entity `created_at` timestamp; `9999-12-31` if missing)
...
- Required: Mandatory
- CSV header: `c0090`
- OptiTech field: — (Auto: `9999-12-31` for active entities)
...
- CSV header: `c0100`
- OptiTech field: Entity > Currency
...
- CSV header: `c0110`
- OptiTech field: Entity > Value of total assets (DORA section)
...
- Required: Mandatory
- CSV header: `c0010`
- OptiTech field: Entity (branch) > Legal Identifiers
...
- Required: Mandatory
- CSV header: `c0020`
- OptiTech field: Entity (branch) > Parent entity > Legal Identifiers > LEI
...
- Required: Mandatory
- CSV header: `c0030`
- OptiTech field: Entity (branch) > Name
...
- Required: Mandatory
- CSV header: `c0040`
- OptiTech field: Entity (branch) > Country
- Export: prefixed with `eba_GA:`
...
- Required: Mandatory
- CSV header: `c0010`
- OptiTech field: Contract > Reference ID
...
- Required: Mandatory
- CSV header: `c0020`
- OptiTech field: Contract > Contract type
...
- CSV header: `c0030`
- OptiTech field: Contract > Overarching Contract > Reference ID
...
- Required: Mandatory
- CSV header: `c0040`
- OptiTech field: Contract > Currency
...
- Required: Mandatory
- CSV header: `c0050`
- OptiTech field: Contract > Annual expense
...
- Required: Mandatory
- CSV header: `c0020`
- OptiTech field: Contract > Beneficiary Entity > Legal Identifiers > LEI
...
- Required: Mandatory
- CSV header: `c0030`
- OptiTech field: Contract > Provider Entity > Legal Identifiers
- Note: first available identifier (LEI > EUID > VAT > DUNS)
...
- Required: Mandatory
- CSV header: `c0040`
- OptiTech field: — (automatically determined based on identifier type used: LEI, EUID, VAT, DUNS)
...
- Required: Mandatory
- CSV header: `c0050`
- OptiTech field: Asset (business function) > Reference ID
...
- Required: Mandatory
- CSV header: `c0060`
- OptiTech field: Solution > ICT Service Type (DORA Assessment section)
...
- Required: Mandatory
- CSV header: `c0070`
- OptiTech field: Contract > Start date
...
- Required: Mandatory
- CSV header: `c0080`
- OptiTech field: Contract > End date
...
- CSV header: `c0090`
- OptiTech field: Contract > Termination reason
...
- CSV header: `c0100`
- OptiTech field: Contract > Notice period for entity (days)
...
- Required: Mandatory if the ICT service is supporting a critical or important function
- CSV header: `c0110`
- OptiTech field: Contract > Notice period for provider (days)
...
- Required: Mandatory if the ICT service is supporting a critical or important function
- CSV header: `c0120`
- OptiTech field: Contract > Governing law country
- Export: prefixed with `eba_GA:`
...
- Required: Mandatory if the ICT service is supporting a critical or important function
- CSV header: `c0130`
- OptiTech field: Contract > Provider Entity > Country
- Export: prefixed with `eba_GA:`
...
- Required: Mandatory if the ICT service is supporting a critical or important function
- CSV header: `c0140`
- OptiTech field: Solution > Storage of data (DORA Assessment section)
...
- CSV header: `c0150`
- OptiTech field: Solution > Location of data at rest
- Export: prefixed with `eba_GA:`
...
- CSV header: `c0160`
- OptiTech field: Solution > Location of data processing
- Export: prefixed with `eba_GA:`
...
- CSV header: `c0170`
- OptiTech field: Solution > Data Sensitiveness (DORA Assessment section)
...
- CSV header: `c0180`
- OptiTech field: Solution > Level of Reliance (DORA Assessment section)
...
- Required: Mandatory
- CSV header: `c0010`
- OptiTech field: Contract (subordinate) > Reference ID
...
- Required: Mandatory
- CSV header: `c0020`
- OptiTech field: Contract > Linked third-party contract reference
...
- CSV header: `c0030`
- OptiTech field: — (Auto: always `true`)
...
- Required: Mandatory
- CSV header: `c0020`
- OptiTech field: — (Auto: main entity identifier for all contracts)
...
- Required: Mandatory
- CSV header: `c0030`
- OptiTech field: — (automatically determined based on identifier type used)
...
- Required: Mandatory
- CSV header: `c0020`
- OptiTech field: — (Auto: provider entity LEI for intra-group contracts)
...
- Required: Mandatory
- CSV header: `c0030`
- OptiTech field: — (Auto: computed based on whether the entity is a branch)
...
- Required: Mandatory
- CSV header: `c0010`
- OptiTech field: Entity (provider) > Legal Identifiers
- Note: first available identifier (LEI > EUID > VAT > DUNS)
...
- Required: Nullable
- CSV header: `c0030`
- OptiTech field: Entity (provider) > Additional identifier (e.g. EUID)
...
- CSV header: `c0040`
- OptiTech field: — (automatically determined based on additional identifier type)
...
- Required: Mandatory
- CSV header: `c0050`
- OptiTech field: Entity (provider) > Name
...
- CSV header: `c0060`
- OptiTech field: Entity (provider) > Name (Latin alphabet transliteration)
...
- Required: Mandatory
- CSV header: `c0070`
- OptiTech field: Entity (provider) > Person Type (DORA section)
...
- Required: Mandatory
- CSV header: `c0080`
- OptiTech field: Entity (provider) > Country
- Export: prefixed with `eba_GA:`
...
- CSV header: `c0090`
- OptiTech field: Contract / Entity (main) > Currency
...
- CSV header: `c0100`
- OptiTech field: — (Auto: sum of `Annual expense` across all contracts with this provider)
...
- Required: Mandatory
- CSV header: `c0110`
- OptiTech field: Entity (provider) > Parent entity > Legal Identifiers
...
- Required: Nullable
- CSV header: `c0120`
- OptiTech field: — (automatically determined based on identifier type used for parent)
...
- Required: Mandatory
- CSV header: `c0020`
- OptiTech field: Solution > ICT Service Type
...
- Required: Mandatory
- CSV header: `c0040`
- OptiTech field: — (automatically determined)
...
- CSV header: `c0060`
- OptiTech field: — (Auto: empty for rank 1)
...
- Required: Mandatory
- CSV header: `c0020`
- OptiTech field: Asset (business function) > Licensed activity (DORA section)
...
- Required: Mandatory
- CSV header: `c0030`
- OptiTech field: Asset (business function) > Name
...
- Required: Mandatory
- CSV header: `c0040`
- OptiTech field: — (Auto: main entity LEI)
...
- Required: Mandatory
- CSV header: `c0050`
- OptiTech field: Asset (business function) > Criticality assessment (DORA section)
...
- Required: Optional
- CSV header: `c0060`
- OptiTech field: Asset (business function) > Criticality justification (DORA section)
...
- Required: Mandatory
- CSV header: `c0070`
- OptiTech field: — (Auto: asset `updated_at` timestamp; `9999-12-31` if missing)
...
- Required: Mandatory
- CSV header: `c0080`
- OptiTech field: Asset (business function) > disaster_recovery_objectives > objectives > rto > value
...
- Required: Mandatory
- CSV header: `c0090`
- OptiTech field: Asset (business function) > disaster_recovery_objectives > objectives > rpo > value
...
- Required: Mandatory
- CSV header: `c0100`
- OptiTech field: Asset (business function) > Discontinuing Impact (DORA section)
...
- Required: Mandatory
- CSV header: `c0050`
- OptiTech field: Solution > Substitutability (DORA Assessment section)
...
- CSV header: `c0060`
- OptiTech field: Solution > Non-Substitutability Reason (DORA Assessment section)
...
- Required: Mandatory
- CSV header: `c0070`
- OptiTech field: — (Auto: solution `updated_at` timestamp)
...
- Required: Mandatory
- CSV header: `c0080`
- OptiTech field: Solution > Exit Plan (DORA Assessment section)
...
- Required: Mandatory
- CSV header: `c0090`
- OptiTech field: Solution > Reintegration Possibility (DORA Assessment section)
...
- Required: Mandatory
- CSV header: `c0100`
- OptiTech field: Solution > Discontinuing Impact (DORA Assessment section)
...
- Required: Mandatory
- CSV header: `c0110`
- OptiTech field: Solution > Alternative Providers Identified (DORA Assessment section)
...
- Required: Optional
- CSV header: `c0120`
- OptiTech field: Solution > Alternative Providers (DORA Assessment section)
