# Event streaming in OptiTech

## OptiTech Kafka consumer specification

### Overview

The consumer is built for OptiTech and is responsible for processing messages that trigger successive API requests. Key features include:
