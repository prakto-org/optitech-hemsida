...
Document purpose: This Security Assurance Plan explains the controls, processes, and evidence that OptiTech provides to protect customer data and ensure the availability, integrity, and confidentiality of the OptiTech platform.
...
This plan covers OptiTech’s SaaS offering of OptiTech and the associated managed infrastructure, operations, and support services. Customer-managed (on-premises) deployments are covered where explicitly noted (see @srm).
...
- Policies & ownership: Security policies are owned by OptiTech leadership and reviewed at least annually.

- Roles: A designated Data Protection Officer (DPO) oversees data protection and privacy. Contact: #link("mailto:contact@optitech-sverige.se"). To report a security issue, please use: #link("security@optitech-sverige.se")
...
- Planned: Progressing toward ISO 27001 certification for OptiTech’s own ISMS, targeted for Q1/2026.
...
- Security: #link("security@optitech-sverige.se")
- Privacy (DPO): #link("contact@optitech-sverige.se")
- General: #link("contact@optitech-sverige.se")
