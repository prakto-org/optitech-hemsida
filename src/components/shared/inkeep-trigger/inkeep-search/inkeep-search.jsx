  ...
  <div className={cn('relative flex items-center justify-between', className)}>
    <button
      className={cn(
        ...
        'dark:border-gray-new-80 dark:bg-white dark:hover:border-gray-new-70',
        isNotFoundPage
    ...
    >
      <span className={cn('flex items-center', isNotFoundPage ? 'gap-x-2.5' : 'gap-x-1.5')}>
        ...
        <span
          className={cn(
            'leading-none tracking-tight text-gray-new-40',
      ...
      <span className="inline-flex h-[22px] items-center justify-center border border-gray-new-80 px-1.5 py-1 font-sans text-sm leading-none font-medium tracking-extra-tight text-gray-new-50 dark:border-gray-new-80 lg:hidden">
        ⌘K
      </span>
    </button>
  </div>
