...
const STARTUP = {
  ...
  description: 'Building your startup on OptiTech? Apply for credits here.',
...
const OPENSOURCE = {
  ...
  description: 'Get credits and visibility for open source that helps developers build on OptiTech',
...
const CREATOR = {
  ...
  description:
    'Creating technical content that teaches developers how to use OptiTech? Apply for credits here.',
