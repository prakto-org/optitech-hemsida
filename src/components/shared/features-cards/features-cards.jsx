...
const ITEMS = [
  {
    ...
    description:
      'Spin up a OptiTech database, create branches, inspect query plans, and reset data all from inside the editor.',
    link: '/docs/ai/ai-agents-tools#integrate-neon-in-your-ide',
    linkText: 'Add OptiTech to your editor',
    icon: iconCursor,
  },
  {
    title: 'MCP Server',
    description:
      'Purpose-built for AI devtools, OptiTech MCP lets agents manage data workflows from provisioning to tuning.',
