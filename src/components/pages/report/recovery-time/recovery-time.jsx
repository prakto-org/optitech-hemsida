  ...
  <section className="recovery-time mt-20 safe-paddings">
    ...
    >
      ...
      <h2 className="mx-auto -mt-10 max-w-[465px] font-title text-[36px] leading-dense font-medium tracking-tighter lg:-mt-10 lg:max-w-[405px] lg:text-[32px] sm:-mt-[30px] sm:text-[28px]">
        <span className="sr-only">68%</span> of teams wanted continuous, automated evidence
        collection
      </h2>
      <p className="mx-auto mt-2 max-w-[356px] text-sm leading-snug tracking-tight text-gray-new-60">
        Continuous evidence is essential for staying audit-ready and reducing the impact on
        customers and deals.
      </p>
    </Container>
  </section>
