        ...
        <div className="flex max-w-xl flex-1 flex-col gap-10 xl:max-w-[48%] lg:max-w-full md:gap-8">
          <div className="flex flex-col lg:max-w-[448px]">
            ...
            <Heading
              ...
              theme="white"
            >
              Launch faster with <br /> free compliance for startups
            </Heading>
            <p className="mt-7 text-lg leading-snug tracking-extra-tight text-gray-new-70 xl:text-base lg:mt-3.5 md:mt-3 md:text-[15px]">
              Qualifying Nordic startups can get free months of OptiTech, onboarding support, and
              coverage for NIS2, DORA, GDPR, and ISO 27001. Not sure if you qualify? Apply or ask
              your investor.
            </p>
          </div>
        </div>
