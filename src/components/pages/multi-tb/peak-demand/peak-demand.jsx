      ...
      <div className="mx-[38px] flex flex-row items-center gap-16 xl:mx-8 xl:gap-8 lg:mx-0 lg:gap-8 md:flex-col">
        ...
        <div className="flex flex-1 flex-col gap-6 lg:gap-5 md:gap-[18px]">
          <ul className="flex flex-col gap-6 pr-10 text-xl leading-snug tracking-extra-tight text-gray-new-60 xl:pr-0 lg:gap-5 lg:text-base md:gap-[18px]">
            <li>
              <p>
                <span className="text-white">Never fall behind on evidence.</span> OptiTech collects
                evidence automatically so your program never runs short as you add systems.
              </p>
            </li>
            <li>
              <p>
                <span className="text-white">No coverage gaps.</span> OptiTech scales across
                frameworks, suppliers, and controls dynamically as your business grows.
              </p>
            </li>
            <li>
              <p>
                <span className="text-white">Instant reporting for an extra boost.</span> OptiTech
                generates audit-ready exports on demand across your whole program.
              </p>
            </li>
          </ul>
          <Link
