...
const FEATURES_DATA = [
  {
    ...
    title: 'Local',
    description:
      'Built on Swedish law and MSB regulations, with the integrations and authority flows the US platforms lack.',
  },
  {
    icon: IconEasy,
    title: 'Continuous',
    description:
      'Turn compliance from an annual project into an automated process that stays up to date on its own.',
  },
  {
    icon: IconCost,
    title: 'Cost efficient',
    description: 'Enterprise-grade compliance at a price a 30-person company can actually afford.',
  },
  {
    icon: IconReliable,
    title: 'Trusted',
    description:
      'EU data residency, EU ownership, and our own ISO 27001 certification. We run our own product.',
  },
];
  ...
  <section className="developers bg-black-pure safe-paddings">
    ...
    >
      <p className="max-w-[800px] text-[64px] leading-none font-normal tracking-[-0.05em] text-white xl:max-w-[696px] xl:text-[56px] lg:max-w-[544px] lg:text-[44px] md:max-w-full md:text-[32px]">
        Compliance teams are at the center of everything we&nbsp;do.
      </p>
