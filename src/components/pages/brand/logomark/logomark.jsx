...
const Logomark = () => (
  <Section
    title="Logomark"
    description="The OptiTech logomark should only be used in places where there is not enough room to display the full logo, or in cases where only brand symbols of multiple brands are displayed."
  >
