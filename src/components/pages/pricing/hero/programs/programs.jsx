...
const PROGRAMS = [
  {
    ...
    description: 'Custom rates for managing compliance across many clients.',
    url: '/programs/agents',
  },
  {
    type: 'Startup Program',
    title: 'Early-stage startups',
    description: 'Get compliant early with discounted onboarding and credits.',
    url: '/startups',
  },
  {
    type: 'Open Source Program',
    title: 'Nonprofits and open source',
    description: 'Discounted plans for mission-driven organizations.',
