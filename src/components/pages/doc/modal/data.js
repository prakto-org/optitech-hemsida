...
const MODALS = [
  {
    ...
    description: 'See how OptiTech branching works in practice.',
    targeting: {
      all: true,
    },
    destination: {
  ...
  },
  {
    id: 'serverless-video',
    embedId: 'llSTZMVrbx8',
    title: 'Watch: OptiTech Database',
    description: 'See OptiTech in action and learn how it simplifies working with Postgres.',
    targeting: {
  ...
  },
  {
    ...
    description: 'See how OptiTech adjusts compute resources to match your workload.',
    targeting: {
