...
const ITEMS = [
  {
    icon: databaseIcon,
    title: '10,000+',
    description: 'Swedish companies are covered by NIS2.',
    className: 'w-[216px] xl:w-48',
  },
  {
    icon: databricksIcon,
    title: 'ISO 27001',
    description: 'We run our own product and certify against it ourselves.',
    ...
    <Container className="z-10" size="1344">
      <div className="relative z-10 flex gap-16 xl:gap-[108px] lg:gap-8 md:gap-5 md:p-0 sm:flex-col sm:gap-20">
        <div className="flex-1 border-l border-gray-new-50 px-8 xl:pr-0 xl:pl-6 lg:pl-[18px] sm:border-none sm:pl-0">
          <SectionLabel className="mb-5 md:mb-4">Built in the Nordics</SectionLabel>
          <h2
            className={cn(
          ...
          >
            <strong>Built in Sweden, backed by experts.</strong> OptiTech was founded by security
            and compliance specialists. All data stays in Swedish and EU data centers.
          </h2>
