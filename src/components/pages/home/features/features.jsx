...
const ITEM_ICONS = {
  nis2Dora: shieldIcon,
  swedishIntegrations: connectionsIcon,
  boardReporting: chartIcon,
  deadlineTracking: clockIcon,
  autoRemediation: boltIcon,
  ssoBankid: keyIcon,
};
...
const Features = () => {
  ...
  const ITEMS = Object.entries(ITEM_ICONS).map(([key, icon]) => ({
    icon,
    ...
    >
      ...
      >
        <div className="min-w-0 border-t border-gray-new-20 pt-9 lg:pt-7">
          <Heading icon="features" title={t.raw('heading')} />
