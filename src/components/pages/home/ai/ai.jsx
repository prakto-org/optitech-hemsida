  ...
  >
    ...
    >
      <div className="min-w-0">
        <Heading title="<strong>An AI copilot fluent in Swedish law.</strong> Ask a question in plain language and the AI does the hard work." />
        <div className="relative mt-[182px] pl-32 xl:mt-[174px] xl:-mr-8 xl:pl-16 lg:-mx-8 lg:mt-[143px] lg:px-0 md:mx-0 sm:mt-11">
          ...
          <div className="mt-px flex items-center justify-between gap-x-4 bg-gray-new-10 px-4 py-3.5 outline outline-1 outline-gray-new-30 lg:px-3.5 lg:py-4 sm:flex-col sm:items-start sm:gap-y-4 sm:px-4 sm:py-4">
            <p className="sm::text-[15px] ml-3 text-[20px] leading-snug tracking-tight text-white lg:text-[18px] sm:ml-0">
              Try for yourself, start automating <br className="hidden md:block" /> with OptiTech
              now.
            </p>
            <CopyCodeButton code="npx optitech init" copyText="npx optitech@latest init" />
          </div>
        </div>
        ...
        <div className="mt-[114px] flex items-center gap-11 xl:mt-[104px] xl:gap-[14px] lg:mt-20 md:mt-[58px] sm:-mx-6 sm:flex-col sm:items-start sm:gap-7">
          <p className="w-[146px] shrink-0 leading-snug font-medium tracking-extra-tight text-gray-new-50 xl:w-32 lg:text-[15px] sm:w-full sm:text-center">
            Ask OptiTech AI from your tools:
          </p>
