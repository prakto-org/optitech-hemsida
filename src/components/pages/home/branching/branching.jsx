...
const FEATURE_ICONS = {
  crossMapping: copyIcon,
  prioritizedActions: anonymIcon,
  alwaysCurrent: ephemeralityIcon,
};

const Branching = () => {
  const t = useTranslations('home.branching');
    ...
    >
      ...
      >
        <div className="min-w-0">
          <Heading icon="branching" title={t.raw('heading')} />
          <RiveAnimation
