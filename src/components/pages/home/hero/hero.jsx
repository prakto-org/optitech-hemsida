...
export const heroServiceItems = [
  {
    title: 'Gap Analysis',
    description: 'Automatic scoping of NIS2, DORA, GDPR, and ISO 27001 requirements.',
  ...
  },
  {
    ...
    description: 'Policies and plans generated in correct regulatory language.',
  ...
  },
  {
    ...
    description: 'Integrations verify MFA, offboarding, and backups around the clock.',
    videoBase: 'compute',
  ...
  },
  {
    ...
    description: 'Guided MSB flow: early warning in 24 hours, report in 72.',
    videoBase: 'storage',
  ...
  },
  {
    ...
    description: 'Questionnaires, risk classing, and DORA-ready ICT registers.',
  ...
  <section className="hero relative mt-16 safe-paddings lg:mt-14">
    <Container className="relative z-30 pt-96 pb-2 xl:pt-54 lg:pt-52 md:px-5! md:pt-53" size="1600">
      <Link href="#backed-by-giants">
        <SectionLabel theme="white">Compliance automation for the Nordics</SectionLabel>
      </Link>
      ...
      <h1 className="mt-5 max-w-280 text-[72px] leading-dense tracking-tighter xl:max-w-215 xl:text-[64px] lg:max-w-180 lg:text-[52px] md:mt-4 md:text-[42px] sm:text-[32px]">
        OptiTech is the compliance platform
        <br />
        built for Nordic businesses.
      </h1>
