...
const FEATURES = [
  {
    title: 'OptiTech Compliance Platform',
    description: 'Secure, cloud-hosted compliance automation for Nordic SMBs and their supply chains.',
    icon: dataIcon,
  },
  {
        ...
        <div className="w-[280px] shrink-0 lg:w-[328px] md:w-1/2 sm:w-full">
          ...
          <div className="mt-4 flex flex-col gap-2 text-with-links leading-snug tracking-extra-tight text-gray-new-70 lg:text-[15px]">
            ...
            <p>
              ...
              <a href="mailto:security@optitech.com">security@optitech.com</a>.
            </p>
          </div>
        </div>
