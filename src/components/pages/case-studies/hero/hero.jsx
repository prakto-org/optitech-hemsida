...
const CARDS = [
  {
    ...
    title:
      'Audit-ready in under a week. <span>How Vercel automates evidence collection across five frameworks.</span>',
  ...
  },
  {
    ...
    title:
      'Compliance operations, made repeatable. <span>How Hasura manages five frameworks with a single team.</span>',
    linkText: 'Read case study',
    ...
    <Container size="branching" className="flex flex-col gap-16 lg:gap-14 md:gap-10">
      <div className="flex max-w-[960px] flex-col gap-5 lt:max-w-[864px] lg:max-w-[640px] md:max-w-none">
        ...
        <h1 className="text-[3.5rem] leading-[1.125] font-normal tracking-tighter text-white lt:text-[54px] lg:text-[40px] md:text-[32px]">
          Real-world stories from teams staying audit-ready and compliant with OptiTech.
        </h1>
      </div>
