...
const ITEMS = [
  {
    title: 'One copilot for every regulation',
    description:
      'Cover NIS2, DORA, the EU AI Act, GDPR, and ISO 27001 in a single system. No spreadsheets or scattered documents.',
    image: everything,
    imageMobile: everythingMobile,
  },
  {
    title: 'Trained on Swedish law',
    description:
      'The AI copilot reads Swedish legal text, drafts policies and risk assessments, and answers your questions in plain language.',
    image: pgvector,
  ...
  },
  {
    ...
    description:
      'OptiTech connects to your systems and collects audit evidence automatically, so your documentation stays current without manual work.',
    image: indexing,
    imageMobile: indexingMobile,
  },
  {
    title: 'Built for Nordic SMBs',
    description:
      'OptiTech integrates with Fortnox, Visma, BankID, and Kivra, keeps your data in the EU, and gets you onboarded in under a week.',
    image: sqlNative,
  ...
  <section className="usage relative mt-[196px] safe-paddings xl:mt-[188px] lg:mt-[159px] md:mt-[102px]">
    <Container className="md:max-w-sm md:px-5" size="960">
      ...
      <p className="mt-3 max-w-lg text-lg leading-snug tracking-tight text-balance text-gray-new-70 lg:text-base md:text-wrap">
        OptiTech maps your systems to the controls that matter, from NIS2 to the EU AI Act.
      </p>
      <Link
