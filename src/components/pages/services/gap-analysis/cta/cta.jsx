...
const Cta = () => {
  const t = useTranslations('services.gapAnalysis.cta');
      ...
      <Container size="960">
        <div className="border-t border-tc-border pt-20 text-center lg:pt-14 md:pt-10">
          ...
          <div className="mt-9 flex items-center justify-center gap-x-4 md:mt-7 md:flex-col md:gap-y-3">
            <Link
              className="inline-flex h-12 items-center gap-x-2.5 bg-tc-purple px-7 text-base font-semibold text-white transition-colors duration-200 hover:bg-tc-purple-text md:h-11"
