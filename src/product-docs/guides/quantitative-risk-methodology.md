---
description: How OptiTech turns probability and loss-bound inputs into LEC charts, VaR, expected shortfall, and ROSI — and how to read those numbers
---
...
OptiTech models annual loss from a risk scenario as a **frequency × severity** process — the standard quantitative-risk approach used in FAIR, OpenFAIR, and most modern CRQ literature.
