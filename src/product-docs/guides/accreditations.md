...
4. _Optional_: expand the **More** dropdown for extended fields:
   ...
   - **Duration (months)** — accreditation validity. If both **Commission date** and **Duration** are filled in and **Expiry date** is blank on save, OptiTech computes the expiry automatically.
