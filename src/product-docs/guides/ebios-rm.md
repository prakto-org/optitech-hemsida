---
description: Step-by-step guide to running an EBIOS RM study in OptiTech — five workshops, content reuse, quotation methods, reports, and Excel round-trip
---
...
The **security foundation** — what ANSSI calls the _socle de sécurité_ — is your existing compliance position: the controls you already have. OptiTech lets you attach one or more existing **audits** rather than re-typing them:
...
OptiTech supports two levels of detail:
...
The same Excel export is **re-importable** into a different OptiTech instance. This is how you share studies across instances (e.g. transferring a study from a consultant's instance to a client's, or restoring an exported study after a migration):
