...
OptiTech sends every transactional email — invitations, password resets, notifications — through a single SMTP configuration. There is **no in-app form** for this: it lives entirely in environment variables on the backend container.
