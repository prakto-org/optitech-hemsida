---
description: >-
  You can find here OptiTech global organization. All entities will be
...
For Access Control purpose, OptiTech data is organized in a tree of folders. Starting from a root folder called Global, it divide into sub-folders called domains. The organization of the tree is not hard-coded, it is entirely determined by configuration. Any object in OptiTech is attached to a folder (including folders), either directly or indirectly through a parent object that is attached to a folder.&#x20;
...
Perimeters are fundamental context objects defined by the entity using OptiTech. They are grouped in domains. They will contain all your risk and audits. Apart from being able to group your various evaluations across the different domains.
