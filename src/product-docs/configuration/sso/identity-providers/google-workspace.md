...
3.  Enter **optitech** or the name of your choice and click on **continue**
...
5.  Fill **ACS URL** with `<base_url>/api/accounts/saml/0/acs/`, enter the **Entity ID** which has to be the same than <mark style="color:purple;">**SP entity Id**</mark> in OptiTech (**optitech** by default) and choose **Email** in **Name ID Format**<br>
...
{% hint style="warning" %}
<mark style="color:orange;">Add a user in your application doesn't automatically create the user on OptiTech</mark>
{% endhint %}

You can now [configure OptiTech](../saml.md#configure-optitech-with-saml) with the <mark style="color:purple;">**3 parameters**</mark> you've retrieved.
