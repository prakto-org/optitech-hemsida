---
description: Configure Okta as an Identity Provider for OptiTech
---
...
6. Add the **Audience URI (**<mark style="color:purple;">**SP Entity ID**</mark>**),** it has to be the same than <mark style="color:purple;">**SP Entity ID**</mark> in OptiTech (see screenshot below)
...
10. In the **Settings** box inside **SAML 2.0:**
    ...
    * Copy  the <mark style="color:purple;">**Metadata URL**</mark> and paste it into the <mark style="color:purple;">**Metadata URL**</mark> field in OptiTech
    * Copy the **Issuer** url and paste it into the <mark style="color:purple;">**IdP Entity ID**</mark> field in OptiTech
