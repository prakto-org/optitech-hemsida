...
The risk assessment is an advanced object that needs special considerations. Make sure to pick the matrix that will be used to map your labels to the values on OptiTech. If you have a specific matrix, you should start by including it as a custom library.
...
The Excel format produced by OptiTech's own EBIOS RM study export — sheets prefixed `1.1 Study`, `1.3 Feared Events`, `2.1 RO/TO`, and so on. This is the round-trip format: export, edit, re-import.
