...
description: >-
  ...
  OptiTech supports both TOTP authenticator apps and WebAuthn security
  keys (FIDO2, hardware keys, fingerprint, passkeys).
---

# Setting up Multi-Factor Authentication (MFA)

OptiTech supports two second-factor methods, and both can be enrolled on the same account:
...
Plus, of course, access to your account settings on OptiTech.
