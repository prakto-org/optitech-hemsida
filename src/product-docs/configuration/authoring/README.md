...
This section gathers the **authoring guidelines** — the conventions, structure, and pitfalls to keep in mind when you create the content that drives OptiTech: frameworks, risk matrices, journey presets, and Excel-driven library content.
