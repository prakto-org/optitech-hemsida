---
description: How OptiTech represents people, groups, and external parties for assignment and responsibility
---

# Actors and teams

Almost every object in OptiTech has an **assignee** — the applied control someone is responsible for, the audit a team is running, the contract a supplier signs. The platform represents all these counterparties through a single abstraction: the **actor**.
...
An actor is the unifying handle for anyone who can be assigned to work in OptiTech. Every actor wraps exactly one of three concrete underlying objects:
