...
A **findings assessment** — called **Follow-up** in the UI — tracks the issues raised by a review and drives their remediation through to closure. Findings can come from an OptiTech audit, an internal security review, a penetration test, an external assessor's report, or any other source.
