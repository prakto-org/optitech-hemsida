...
For policies authored in OptiTech, every change produces a new **revision** of the managed document rather than overwriting the previous text. Each revision carries:
