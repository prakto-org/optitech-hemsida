...
A **domain** is a top-level container in OptiTech. It represents an organisational scope — a business unit, a subsidiary, or any boundary you want to manage access and reporting around.
