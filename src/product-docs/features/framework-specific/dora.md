...
The EU [Digital Operational Resilience Act](https://www.eiopa.europa.eu/digital-operational-resilience-act-dora_en) (DORA) imposes two specific reporting obligations that OptiTech produces out of the box: the **Register of Information** on ICT third-party arrangements, and structured **major incident reports** filed with the supervisory authority.
...
OptiTech builds this register from the entities, solutions, and contracts you already track in the **third-party risk** module:
...
OptiTech ships a dedicated **DORA incident report** object:
