---
description: Experimenting OptiTech through remote server or hypervisor
---
...
Let's say that you want to setup or experiment with OptiTech on a Network or Virtualized environment (eg. Hypervisor) on a remote host, for instance, to use with multiple users:
...
Your OptiTech can be reached now from  `https://cool-vm:8443`, and you can skip the SSL warning for the self-signed certificate.
