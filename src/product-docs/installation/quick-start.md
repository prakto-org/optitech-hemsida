...
- clone the repo: `git clone <optitech-deployment-repo>`
...
3. Create a namespace: `kubectl create ns optitech`
4. Install: `helm install optitech-release oci://<optitech-registry>/optitech -f custom.yaml -n optitech`
