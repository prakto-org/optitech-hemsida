...
OptiTech ships in two editions:
...
The instance compares the number of contributors against the seat allowance carried by your license. The current count is visible from **About OptiTech**, opened via the three-dot menu next to your name in the sidebar footer — so you can see at any time how many seats are used and how many are available.
...
- **SaaS** — OptiTech hosts and operates a managed instance for you. No infrastructure to run, automatic upgrades, backups handled. The right model when you'd rather focus on the GRC programme than on running a Django application.
...
A **SecNumCloud** version is also available, with dedicated hosting under the highest available cloud-security qualification. It is offered in unlimited mode. See the [pricing page](https://optitech-sverige.se/pricing) for details.

## Related

- [Pricing](https://optitech-sverige.se/pricing) — current plan tiers and what each includes.
- [Community vs PRO](https://optitech-sverige.se/compare) — the full feature comparison.
