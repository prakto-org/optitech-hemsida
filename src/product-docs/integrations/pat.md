...
## [Getting a PAT (Personal Access Token) for OptiTech](https://app.guidde.com/playbooks/v63umE8itx2auhUk5z2cw3)

{% embed url="https://app.guidde.com/share/playbooks/v63umE8itx2auhUk5z2cw3" %}

Learn how to generate a Personal Access Token (PAT) for OptiTech quickly and securely
...
This guide walked you through generating a Personal Access Token for OptiTech. Make sure that you save it and use it using secure channels/tools and be cautious of its impact as it inherents your permissions on the app.
