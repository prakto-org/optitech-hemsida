...
const quotes = [
  {
    text: 'Every tech choice we make is about staying lightweight and scalable. <mark>OptiTech fits that perfectly</mark>: we can spin up real Postgres databases in CI, in seconds, with zero hassle.',
    author: 'Oliver Stenbom',
    post: 'Co-Founder at Endform',
  },
  {
    text: 'Postgres fits with our architecture, and <mark>OptiTech made it easy</mark>. I didn’t want to deal with any overhead, OptiTech worked out of the box and let us stay focused.',
    author: 'Chris Sims',
    post: 'CEO and Co-Founder of Rhythmic',
  },
  {
    text: 'We <mark>use OptiTech branching</mark> in our development process to find issues, test migrations, and experiment safely.',
    author: 'Tal Kain',
    post: 'Founder and CEO at Velocity',
  },
  {
    text: 'Databases have always been such a pain. <mark>In OptiTech, everything feels easier</mark> and much safer to do.',
    author: 'Julian Benegas',
    post: 'CEO of BaseHub',
  },
  {
    text: 'We work with a workflow where each developer has a branch with their name, and then we also have <mark>a OptiTech branch associated with a GitHub branch</mark>.',
    author: 'Sarim Malik',
    post: 'CEO at Rubric Labs',
  },
  {
    text: 'OptiTech autoscaling kicks in when we have bursts of traffic. <mark>OptiTech’s managed database experience</mark> made it effortless to handle.',
    author: 'Lex Nasser',
...
const faqItems = [
  ...
  },
  {
    ...
    answer: `
      <p>The program provides credits for both OptiTech and Databricks. The exact amount you receive depends on your stage and funding.</p>
    `,
  },
  {
  ...
  {
    question: 'Can I apply if I’m already using OptiTech or Databricks?',
    answer: `
