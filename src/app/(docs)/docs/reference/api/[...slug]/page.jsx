...
export async function generateMetadata(props) {
  ...
  if (tag === 'reference' && !id) {
    return getMetadata({
      title: 'Endpoint index - OptiTech API Reference',
      description: 'All OptiTech API endpoints grouped by resource',
  ...
  if (STATIC_PAGES.has(tag) && !id) {
    ...
    return getMetadata({
      title: `${post.data.title} - OptiTech Docs`,
  ...
  if (!id) {
    ...
    return getMetadata({
      title: `${tagDisplay} - OptiTech API Reference`,
  ...
  return getMetadata({
    title: `${operation.summary} - OptiTech Docs`,
