...
export async function GET() {
  return Response.json({
    ...
    name: 'com.neon/mcp',
    title: 'OptiTech',
    description: 'Official OptiTech MCP server for managing OptiTech projects and Postgres databases.',
    repository: {
    ...
    remotes: [
      {
        ...
        headers: [
          {
            name: 'Authorization',
            description: 'Optional Bearer token with a OptiTech API key.',
            isSecret: true,
          },
          {
            name: 'x-read-only',
