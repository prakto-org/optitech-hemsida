...
// OptiTech AI Gateway model catalog — the source of truth for the AI Gateway docs.
//
...
// read this endpoint.
//
// Every entry is live-verified against the OptiTech AI Gateway (text output +
// image-input + tool-calling probed directly). The data in ./data.json is
// generated from the OptiTech provider definition in models.dev and committed here
