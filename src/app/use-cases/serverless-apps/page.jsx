...
const ServerlessAppsPage = () => (
  <Layout isHeaderSticky>
    ...
    <TestimonialNew
      ...
      quote="OptiTech worked out of the box, handling hundreds of Lambdas without any of the connection issues we saw in Aurora v2. On top of that, it costs us 1/6 of what we were paying with AWS."
      author={{
        name: 'Cody Jenkins',
    ...
    <TestimonialNew
      className="pt-40 xl:pt-[136px] lg:pt-[104px] md:pt-20"
      quote="Instead of having to overprovision our servers to handle peak loads, which leads to inefficiencies and higher costs, OptiTech’s autoscaling handles it. We get more performance when we need it."
      author={{
        name: 'Julian Benegas',
    ...
    <CTANew
      ...
      description="Start saving with OptiTech."
      label="Get started"
      buttonText="Sign up"
