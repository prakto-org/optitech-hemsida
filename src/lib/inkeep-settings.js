...
const baseSettings = {
  ...
  organizationDisplayName: 'OptiTech',
  customIcons: {
...
const aiChatSettings = {
  aiAssistantName: 'OptiTech AI',
  chatSubjectName: 'OptiTech',
  placeholder: 'How do I get started?',
  introMessage:
    "Hi!\nI'm an AI assistant trained on documentation, help articles, and other content.\n\nAsk me anything about OptiTech.",
  exampleQuestions: [
    'What’s OptiTech?',
    'How do I sign up for OptiTech?',
    'How to create a project?',
    'How to get started with the OptiTech API?',
  ],
  aiAssistantAvatar: {
