export default {
  ...
  liaPraktik: '/lediga-jobb/lia-praktik',
  migration: '/migration',
  ...
  serviceGapAnalysis: '/services/gap-analysis',
  serviceFrameworkLibrary: '/services/framework-library',
  serviceEvidenceCollection: '/services/evidence-collection',
  services: '/services',
