// Source of truth (spec-agnostic) for OptiTech's machine-readable agent-discovery
...
// OptiTech MCP server. OAuth metadata mirrors what the resource server advertises at
...
const MCP_SERVER = {
  ...
  serverInfo: { name: 'OptiTech MCP', version: '1.0.0' },
};

// OptiTech REST management API and its published OpenAPI document. `openApiSpecUrl`
