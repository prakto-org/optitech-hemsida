...
OptiTech URLs follow this shape:
...
<CTA title="Try the URL in psql" description="Walk through connecting to OptiTech with the psql client, including SNI workarounds for older versions." buttonText="psql guide" buttonUrl="/docs/connect/query-with-psql-editor" />
