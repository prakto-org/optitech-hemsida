...
Options include Node.js (`pg`), Prisma, Drizzle, the [OptiTech serverless driver](/docs/serverless/serverless-driver) for edge runtimes, Python (`psycopg2`, `asyncpg`), Go (`pgx`), Java (JDBC), Ruby, Rust, PHP, .NET, and more. Each snippet shows how to use the connection string with that library's connection helper.
