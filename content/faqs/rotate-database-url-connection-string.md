...
In OptiTech, your `DATABASE_URL` is built from the role, password, hostname, and database name. To rotate the URL, you change the credential that backs it. There are two reasonable approaches:
...
1. Open the [OptiTech Console](https://console.neon.tech), select your project, then **Branches → branch → Roles & Databases**.
