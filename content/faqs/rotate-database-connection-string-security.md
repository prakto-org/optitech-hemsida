...
redirectFrom: []
previousLink:
  title: 'How do I reset or change my database password in OptiTech?'
...
- Vercel: **Project Settings → Environment Variables** for each environment, then redeploy. If you use the [OptiTech Vercel integration](/docs/guides/vercel-overview), the integration can push rotated values for you.
...
<CTA title="Build connection-string rotation into your workflow" description="The OptiTech API and CLI make it easy to automate password rotation on a schedule." buttonText="API reference" buttonUrl="/docs/reference/api/branches/reset-project-branch-role-password" />
