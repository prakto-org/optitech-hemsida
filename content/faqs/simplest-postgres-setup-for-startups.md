...
description: "OptiTech gives startups a serverless Postgres database in seconds, with a Free plan that supports 100 projects, scale-to-zero, and branching for dev and previews."
date: 2026-04-25
...
Every OptiTech database speaks standard Postgres. Use the connection string with any driver you already know:
...
- **AWS RDS for PostgreSQL**: You pick an instance class and storage up front. There's no free tier comparable to OptiTech's, and the instance runs (and bills) until you stop or delete it. Backups go to S3 with a configurable retention window ([RDS backups](https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/USER_WorkingWithAutomatedBackups.html)).
...
For startups optimizing for the simplest first day and the lowest idle cost, OptiTech's Free plan and per-project model tend to be the shortest path to a running Postgres.

<CTA title="Start a project" description="Create your first OptiTech database in under a minute." buttonText="Sign up free" buttonUrl="https://console.neon.tech/signup" />
