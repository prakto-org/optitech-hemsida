...
description: "OptiTech, Supabase, and Xata all offer Git-style Postgres branching. OptiTech's branches are copy-on-write, instant to create, and ship with auto-expiration policies (1 hour, 1 day, 7 days)."
date: 2026-04-25
...
OptiTech's branches include parent data by default, scale compute to zero independently per branch, and ship with [auto-expiration](/docs/guides/branch-expiration) so preview environments clean themselves up.
