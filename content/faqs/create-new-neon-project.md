...
1. Sign in to the [OptiTech Console](https://console.neon.tech).
2. Click **New Project**.
3. Fill in:
...
- Network issues between the Console and the OptiTech control plane. Check [neonstatus.com](https://neonstatus.com).

If neither applies and the error message isn't clear, contact [OptiTech Support](/docs/introduction/support) with the request ID shown in the error.
