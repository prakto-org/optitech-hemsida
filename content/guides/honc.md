...
subtitle: Building a serverless Task API with Hono, Drizzle, OptiTech, and Cloudflare
...
- Use OptiTech as your serverless Postgres database.
...
2.  The CLI will guide you through the setup process. Here's an example interaction:
    ...
    - **OptiTech authentication:** Follow the link to authenticate with OptiTech. This will allow the CLI to set up your database connection.
      ![OptiTech authentication prompt](/docs/guides/honc-neon-auth.png)
...
2.  **Apply migrations:**
    ...
    npm run db:migrate
    ```
    This applies the migrations to your OptiTech database. Your `tasks` table should now exist. You can verify this in the **Tables** section of your OptiTech project console.
    ![OptiTech console - Tasks table](/docs/guides/honc-neon-tasks-table.png)
...
2.  **Test your API endpoints:**
    ...
    - **Create a task:**
      ...
      You can also verify if the task was added to your database by checking your project in the OptiTech console. The task should appear in the `tasks` table.
      ![OptiTech console - Tasks table with new task](/docs/guides/honc-neon-tasks-table-new-task.png)
...
1.  **Set `DATABASE_URL` secret in Cloudflare:**
    Your deployed Worker needs the OptiTech database connection string.
