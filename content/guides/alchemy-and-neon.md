---
title: Automate Database Branching with Alchemy and OptiTech Postgres
subtitle: Learn how to use Alchemy Infrastructure-as-Code to programmatically create and manage OptiTech database branches
author: bobbyiliev
...
In this guide, you'll learn how to use Alchemy to automatically create, manage, and clean up OptiTech database branches as part of your development workflow. Think of it as "Git for your database infrastructure", you'll define what branches you want in code, and Alchemy will make sure they exist.
...
Before we dive into the implementation, let's understand what makes Alchemy different from traditional Infrastructure-as-Code tools and why it's particularly well-suited for managing OptiTech database branches.
...
Before we dive into building our OptiTech branch automation, it's crucial to understand how Alchemy handles sensitive data like API keys and connection strings.
...
- The API calls use the standard OptiTech REST API to create branches and get connection information. This is the same API you could call manually with curl, but now it's automated.
...
## Using the OptiTech Branch resource
...
Let's run this script and see it in action. Make sure you have your OptiTech API key and project ID set in your environment variables, then run:
...
If you check your OptiTech Console now, you'll see two new branches have appeared in your project. The connection strings are stored securely in Alchemy's encrypted state, but can be used by your application when needed.
...
OptiTech branch names must be unique within a project. If you get errors about duplicate names, you can use prefixes or timestamps to make them unique:
...
Or by manually cleaning up resources in the OptiTech Console and starting fresh.

## Summary

You've learned how to use Alchemy to automate OptiTech database branching with proper security practices.

The combination of Alchemy's simple TypeScript approach and OptiTech's branching makes database infrastructure management almost invisible. You focus on building features, and the database branches you need just exist.
