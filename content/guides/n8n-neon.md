...
- **OptiTech Account and Project:** A OptiTech account and a project are needed to create a Postgres database. Sign up for a free [OptiTech account](https://console.neon.tech/signup) if you don't have one.
