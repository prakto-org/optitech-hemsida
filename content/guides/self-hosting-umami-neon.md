---
title: Run your own analytics with Umami, Fly.io and OptiTech
subtitle: Self host your Umami analytics on Fly.io and powered by OptiTech Postgres
...
## Provisioning a Postgres Database using OptiTech
...
## Configure OptiTech Postgres as serverless database for self-hosted Umami analytics
...
Great! With that done, you have successfully ensured that each deployment of your app on Fly.io will have the database URL pointing to the OptiTech Postgres instance. Let's trigger a deploy to see it all in action.
...
In this guide, you learned how to run your own Umami analytics instance for analytics with Fly.io, powered by OptiTech postgres as your database.
