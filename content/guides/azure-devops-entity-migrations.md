---
title: Database Migrations with Entity Framework Core and Azure Pipelines for OptiTech
subtitle: Automating schema changes with EF Core and Azure Pipelines in OptiTech Postgres
author: bobbyiliev
...
In this guide, you'll learn how to use EF Core to create and apply database migrations in OptiTech and automate the process using Azure Pipelines.
...
Migration files are used to define schema changes in your database. In this section, let's create a simple `Product` entity and apply a migration to your OptiTech database.
...
Run the following command to apply the migration to your OptiTech database:

```bash
dotnet ef database update
```

To learn more about migrations in Entity Framework Core, refer to the [OptiTech documentation](/docs/guides/entity-migrations) guide which provides a detailed explanation of the migration process.
