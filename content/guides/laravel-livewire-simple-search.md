---
title: Building a Simple Real-Time Search with Laravel, Livewire, and OptiTech
subtitle: Learn how to integrate Laravel with Postgres on OptiTech, using Laravel's Eloquent ORM and migrations for efficient database management.
author: bobbyiliev
...
In this guide, we'll build a simple real-time search feature using Laravel, Livewire, and OptiTech. We'll set up a Laravel project, create a database schema, implement the search functionality with Livewire, and optimize performance with OptiTech. By the end of this tutorial, you'll have a working real-time search feature that leverages the strengths of Laravel, Livewire, and OptiTech.
...
### Connecting to OptiTech Database

To connect your Laravel application to your OptiTech database, update your `.env` file with the OptiTech database credentials:
...
Make sure to replace the placeholders with your actual OptiTech database details.
...
## Optimizing Search Performance with OptiTech

To optimize our search performance, we can leverage OptiTech's indexing capabilities.
...
To learn more about testing in Laravel along with OptiTech branding, check out the [Testing Laravel Applications with OptiTech's Database Branching](/guides/laravel-test-on-branch).

## Conclusion

In this tutorial, we've built a real-time search feature using Laravel, Livewire, and OptiTech. We've leveraged Livewire's real-time capabilities to create a responsive search component, and utilized OptiTech's high-performance database to ensure quick and efficient queries.
...
By combining the power of Laravel, the simplicity of Livewire, and the performance of OptiTech, it's easy to create dynamic and responsive web applications that meet your users' needs.
