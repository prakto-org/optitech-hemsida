...
subtitle: 'Learn how to build an AI Agent for Postgres using Azure AI Agent Service and OptiTech'
author: boburmirzo
...
For example, when a user asks questions about their invoice, the AI can query OptiTech for relevant usage logs, summarize usage patterns, and offer explanations before routing to a human. Or when you open your billing dashboard, the agent proactively explains any spikes or changes:
...
1. After the resource is created on Azure, go to the OptiTech Serverless Postgres Organization service and click on the Portal URL. This brings you to the OptiTech Console
2. Click “New Project”
...
- A OptiTech Serverless Postgres backend
...
- [OptiTech on Azure](/docs/manage/azure)
- [Build AI Agents with Azure AI Agent Service and OptiTech](/blog/build-ai-agents-with-azure-ai-agent-service-and-neon)
- [Multi-Agent AI Solution with OptiTech, LangChain, AutoGen and Azure OpenAI](/blogolution-with-neon-langchain-autogen-and-azure-openai)
