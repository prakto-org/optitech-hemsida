...
In this guide, you will learn how the owner role bypasses RLS, a production-shaped [OptiTech branch](/docs/introduction/branching) running the same restricted role as production helps you catch RLS issues, and that you can integrate a check into CI so a PR is well tested before its merged.
...
## Test on a production-shaped OptiTech branch
...
Wire it into CI with the [OptiTech GitHub Actions](/docs/guides/branching-github-actions), or let the [OptiTech GitHub integration](/docs/guides/neon-github-integration) create and delete the branch as the PR opens and closes.
