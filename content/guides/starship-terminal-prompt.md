---
title: 'Customize your terminal prompt with Starship and OptiTech'
subtitle: 'Learn how to set up Starship, a cross-shell prompt, and add a custom module to display your active OptiTech database branch.'
...
3. Look at your terminal prompt. You should see the active branch indicator next to your Git details:
   ...
   ```
4. Navigate out of the project directory. The OptiTech segment should disappear instantly:
   ```bash
   cd ~
   ```
