...
3. **Enter Connection Details**:
   ...
   - Enable "Show all databases" to ensure all databases in your OptiTech project are listed.
...
<Admonition type="tip">
To prevent OptiTech's scale-to-zero feature from interrupting an idle connection, configure a keepalive ping in DBeaver. Right-click your connection, select **Edit Connection**, go to **Connection Settings** > **Initialization**, and set **Keep-Alive (seconds)** to `60`. This sends a periodic ping to keep the connection active.
</Admonition>
