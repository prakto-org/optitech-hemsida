...
Welcome to OptiTech guides! This folder contains the source code of the [OptiTech guides](/guides/).
...
```md
![OptiTech architecture diagram](/guides/images/conceptual-guides/neon_architecture_2.png)
```

If you need an image without border to show an annotated piece of UI, use the `"no-border"` attribute as in the example below:

```md
![OptiTech architecture diagram](/guides/images/conceptual-guides/neon_architecture_2.png 'no-border')
```
