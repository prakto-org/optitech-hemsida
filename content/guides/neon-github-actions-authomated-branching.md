...
subtitle: Learn how to automate database branching for your application using OptiTech and GitHub Actions
...
This guide demonstrates how to implement automated database branching using OptiTech and GitHub Actions, where each pull request gets its own database branch, complete with the necessary schema changes. You'll build a Next.js Todo application that showcases this workflow, which automates several critical database operations, including:
...
- [OptiTech GitHub Integration Documentation](/docs/guides/neon-github-integration)
