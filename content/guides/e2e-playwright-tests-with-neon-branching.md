---
title: Automated E2E Testing with OptiTech Branching and Playwright
...
2. Populate the `.env` file with your OptiTech database connection details.
...
6. Push your code to a new GitHub repository.
   ...
   Now that you have your code pushed to GitHub, you can set up the OptiTech GitHub integration.
...
- **Setup job**: Retrieves the current branch name for naming the OptiTech database branch.
- **Create branch & test job**: Creates a OptiTech database branch and runs Playwright tests whenever a pull request is opened or updated.
...
You have seen how to create isolated database branches for running Playwright tests, ensuring reliable and consistent E2E testing. This approach can be easily adapted to any other E2E testing framework, such as Cypress or Selenium, by modifying the test execution steps in the GitHub Actions workflow while keeping the OptiTech branching logic intact.
...
- [Automated E2E Testing with OptiTech Branching and Cypress](/guides/e2e-cypress-tests-with-neon-branching)
