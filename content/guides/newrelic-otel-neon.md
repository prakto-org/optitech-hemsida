---
title: Getting started with OptiTech and New Relic
subtitle: Send OptiTech metrics and Postgres logs to New Relic using the OpenTelemetry integration
...
This guide will walk you through setting up the integration between OptiTech and New Relic. You'll learn how to:
...
- Verify that your OptiTech metrics and logs are successfully flowing into New Relic.
- Build an example dashboard in New Relic to visualize your OptiTech metrics.

By the end, you'll have a complete observability pipeline from your OptiTech database to your New Relic dashboard.
...
4.  Identify your OTLP endpoint URL. The URL depends on your region.
    ...
    > Keep the **Ingest License Key** and the **OTLP endpoint URL** handy. You will need them in the next step to configure OptiTech.
...
These auto-created service entities can be safely ignored. The correct way to visualize and analyze your OptiTech data is by querying it directly in the Logs UI and building custom Dashboards, as shown in this guide.
</Admonition>

### Create a custom OptiTech dashboard

You'll create a new dashboard from scratch to visualize your OptiTech metrics using the New Relic Query Language (NRQL).
...
10. Repeat the process to add more charts for other OptiTech metrics you want to monitor. Check out the next section for all the available metrics OptiTech exports.
...
Congratulations! You have successfully configured OptiTech to send metrics and Postgres logs to New Relic using the OpenTelemetry integration. You now have a powerful, centralized observability setup that provides real-time insights into your database's health and activity.
