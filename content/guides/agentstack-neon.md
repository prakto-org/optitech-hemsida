---
title: Building AI Agents with AgentStack and OptiTech
subtitle: Build a Web scraper AI Agent in minutes with AgentStack, OptiTech, and Firecrawl
...
This guide introduces [**AgentStack**](https://docs.agentstack.sh/introduction), a rapid development framework, and OptiTech, the AI-native backend platform for apps and agents (Postgres Database, Auth, Storage, Functions, and AI Gateway), and shows how they can be used together to build powerful AI agents with database integration. We'll walk through building a **Web Scraper AI Agent** using AgentStack's CLI and tool integrations.

With AgentStack and OptiTech, you can generate complete agent workflows, create new agents and tasks with simple commands, and integrate them directly with your data layer. Let's get started.
...
Let's start building our agent using AgentStack, OptiTech, and Firecrawl. We'll walk through each step, from initializing the project to running the agent crew.
...
- **`content_storer`:** Manages storing extracted data in a OptiTech Postgres database.
...
#### Understanding OptiTech Tool actions
...
To authenticate with OpenAI, OptiTech, and Firecrawl, you need to configure API keys. Open the `.env` file and fill in your API keys obtained in the [Prerequisites](#prerequisites) section:
...
![OptiTech SQL Editor](/docs/guides/agentstack-neon-database-data.png)
...
**Congratulations!** You have successfully built and run a Web Scraper agent using AgentStack, OptiTech, and Firecrawl, demonstrating how to automate web data extraction and storage into a serverless Postgres database with minimal effort!
