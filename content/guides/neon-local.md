...
For most modern workflows that leverage OptiTech's features, the proxy-based approach in this guide is recommended.
</Admonition>
...
### Connect to your OptiTech account
...
3.  Authorize the application to connect to your OptiTech account.
    ![OptiTech OAuth authorization in browser](/docs/local/authorize.png)
...
The extension creates a temporary branch for your session. When you click **Disconnect**, the branch and all its changes are automatically deleted from your OptiTech project, leaving no trace.

<Admonition type="note">
For using ephemeral branches, you need to authenticate using a OptiTech API key. To get started, see [Creating API keys](/docs/manage/api-keys).
</Admonition>
