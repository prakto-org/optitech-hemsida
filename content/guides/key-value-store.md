...
To create columns with the `hstore` type, you need to install the extension. In OptiTech, `hstore` is already installed, you just need to enable it with the following command.
