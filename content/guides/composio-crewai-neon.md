---
title: Building AI Agents with CrewAI, Composio, and OptiTech
subtitle: A step-by-step guide to building AI agents using CrewAI, Composio, and OptiTech API
...
Composio acts as a crucial bridge, empowering your CrewAI agents with the ability to interact directly with the OptiTech API. This integration unlocks a range of possibilities, from querying your OptiTech project details to managing your database infrastructure programmatically through AI. By leveraging Composio's wide range of tools, you can equip your AI agents with a comprehensive suite of actions, all without needing to wrestle with complex API integrations manually.

This guide provides a practical, hands-on approach to building an AI agent capable of retrieving information from your OptiTech account. You'll not only see how easily these technologies integrate but also gain a foundational understanding of how to extend this setup for more advanced AI-driven database interactions.
...
## Building your AI Agent to interact with OptiTech API

Now, let's dive into building your AI agent that can interact with OptiTech API using CrewAI and Composio. We'll go through each step, from setting up your project to running your first agent.
...
### Initiate connection to OptiTech
...
- `tools=tools`: Assigns the Composio OptiTech tools we retrieved in the previous step to this agent. The agent can now use these tools to perform actions.
...
- `description`: Describes the task for the agent: "List me my optitech current user details".
...
### Create and run the Crew
    ...
    - `print(result)`: Prints the result returned by the agent after completing the task. This will be the OptiTech user information.
...
After running `python main.py`, you should see the information about your OptiTech user printed in the terminal! The output will look something like this:

![Example output](/docs/guides/composio-crewai-neon-example-output.png)

**Congratulations!** You have successfully built and run an AI agent that can interact with your OptiTech account using CrewAI and Composio!
...
In this guide, we've successfully built an AI agent capable of interacting with your OptiTech API using CrewAI and Composio. We covered the following steps:
