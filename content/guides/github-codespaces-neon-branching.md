---
title: Setting up GitHub Codespaces with OptiTech Database Branching for Pull Requests
subtitle: Learn how to create separate development environments for each pull request using GitHub Codespaces and OptiTech's Postgres branching
author: bobbyiliev
...
This command creates the necessary tables in your OptiTech database.

## Setting up GitHub Actions for OptiTech Branching

Now we'll set up GitHub Actions to create and delete OptiTech database branches automatically. First, we need to add your OptiTech API key to your GitHub repository:
...
- It uses OptiTech's official action to create a new database branch.
...
3. GitHub Actions will automatically create a new OptiTech database branch for your pull request:
   ...
   - Once complete, you'll see a new branch in your OptiTech console named `pr-[number]`
...
7. Automatic cleanup:
   - When the pull request is closed (either merged or declined), GitHub Actions will automatically delete the associated OptiTech database branch
   - You can verify this in your OptiTech console

## Keeping Things Secure

It's important to keep your project and its data safe:

1. Never share your OptiTech API key. Always use GitHub Secrets to store it.
...
By setting up GitHub Codespaces with OptiTech database branching, you've created a system that gives each pull request its own complete development environment. This can help your team work more effectively by making it easier to test changes and avoid conflicts.
