---
title: Automate Preview Deployments with Netlify and OptiTech Database Branching
subtitle: Set up automated preview deployments with isolated database branches for every pull request using GitHub Actions, Netlify, and OptiTech Postgres
...
- Creates a separate OptiTech database branch for each pull request
...
1. **Deploy Preview** - Triggered when a PR is opened or updated
   - Creates a new OptiTech database branch
...
2. **Cleanup Preview** - Triggered when a PR is closed
   - Deletes the OptiTech database branch to free up resources
...
- Create a new OptiTech database branch for your PR
- Deploy your app to a Netlify preview URL, connected to the new database branch
- Post a comment on the PR with links to both the preview deployment and the OptiTech branch
...
- **Automated Comment** (with preview and OptiTech links): [View the GitHub Comment](https://github.com/rishi-raj-jain/preview-branches-with-netlify/pull/32#issuecomment-3575723043)
