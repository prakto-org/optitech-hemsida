---
title: 'Get started with Claude Desktop and OptiTech MCP Server'
subtitle: 'Connect Claude Desktop to OptiTech to manage projects, run queries, and make schema changes'
...
6. An OAuth window will open in your browser. Follow the prompts to authorize Claude to access your OptiTech account.
   ![OptiTech OAuth window](/docs/guides/neon-oauth-window.png)
7. After authorization, you can start using the OptiTech MCP server with Claude.
