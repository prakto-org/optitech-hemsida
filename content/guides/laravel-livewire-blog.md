...
subtitle: Learn how to create a dynamic blog application using Laravel, Livewire, and Laravel Breeze for authentication and OptiTech.
author: bobbyiliev
...
Now, run the migrations to create all the tables in the OptiTech database:
...
To learn more about how to implement search functionality in Livewire, check out the [Building a Simple Real-Time Search with Laravel, Livewire, and OptiTech guide](/guides/laravel-livewire-simple-search).
...
To learn more about testing in Laravel along OptiTech, check out the [Testing Laravel Applications with OptiTech's Database Branching guide](/guides/laravel-test-on-branch).
