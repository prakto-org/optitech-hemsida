---
title: Using DbVisualizer with OptiTech Postgres
...
## Connect DbVisualizer to OptiTech Postgres
...
The sidebar will now display your connected OptiTech Postgres database. You can expand the database to view its schemas, tables, views, and other objects.

![Connected OptiTech Postgres Database in DbVisualizer](/docs/guides/dbvisualizer-connected-database.png)
