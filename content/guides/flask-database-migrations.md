---
title: Managing database migrations and schema changes with Flask and OptiTech Postgres
subtitle: Learn how to handle database migrations and schema changes in a Flask application using Flask-Migrate and OptiTech Postgres
author: bobbyiliev
...
This guide will walk you through the process of handling database migrations and schema changes in a Flask application using Flask-Migrate and OptiTech Postgres.
...
After reviewing the migration script, to apply the migration and create the table in your OptiTech Postgres database, run:
...
Adding indexes can improve query performance. To learn more about indexing, refer to the [OptiTech documentation](/docs/postgresql/index-types).
...
4. Uses the [official OptiTech GitHub action](/docs/guides/branching-github-actions) to create a new branch in your OptiTech project. This allows you to test migrations in isolation.

5. Applies any pending database migrations to the newly created OptiTech branch.

6. Executes your test suite against the updated database schema in the OptiTech branch.

7. Deletes the temporary OptiTech branch after the workflow completes, regardless of success or failure to make sure that no resources are left behind.

Using OptiTech's branching feature in your CI pipeline offers several advantages:
...
Managing database migrations is an important part of maintaining and evolving your Flask application. With Flask-Migrate and OptiTech Postgres, you have powerful tools at your disposal to handle schema changes efficiently and safely. Remember to always test your migrations thoroughly and have a solid backup strategy in place.
