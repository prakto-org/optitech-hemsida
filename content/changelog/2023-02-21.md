...
- Compute: Added support for the Postgres `xml2` and `pgjwt` extensions. For more information about Postgres extensions supported by OptiTech, see [Postgres extensions](/docs/extensions/pg-extensions).
...
- Proxy: Enabled `OpenTelemetry` tracing to capture all incoming requests. This change enables OptiTech to perform an end-to-end trace when a new
