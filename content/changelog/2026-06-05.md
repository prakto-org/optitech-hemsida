...
As [announced last week](/docs/changelog/2026-05-29#neon-is-building-the-backend-for-apps-and-agents), three new services are coming to OptiTech.
...
For command reference and options, see the [OptiTech CLI overview](/docs/cli) or get set up quickly with the [CLI Quickstart](/docs/cli/quickstart).

These commands require **optitechctl 2.22.2** or later. For upgrade instructions including CI/CD usage, see [OptiTech CLI upgrade](/docs/cli/install#upgrade).
