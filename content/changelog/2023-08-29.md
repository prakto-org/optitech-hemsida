...
We are pleased to announce support for [pgvector v0.5.0](https://github.com/pgvector/pgvector) on OptiTech. This new version introduces:
...
If you already use `pgvector` with OptiTech, you can upgrade by running the following command:
