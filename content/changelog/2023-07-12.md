...
### Introducing the OptiTech CLI

OptiTech is pleased to announce the release of the [OptiTech CLI](/docs/cli), a command-line interface that enables developers to manage OptiTech resources directly from the terminal. The OptiTech CLI supports numerous operations, including creating and managing projects, branches, databases, roles, read replicas, and more, directly from your terminal. You can also use OptiTech CLI commands in developer workflows and pipelines.
![OptiTech CLI help](/docs/changelog/neon_cli.jpg)

You can install the OptiTech CLI with a single command:
...
To get started with the OptiTech CLI, read the [blog post](/blog/cli) or refer to the [OptiTech CLI reference](/docs/cli).
