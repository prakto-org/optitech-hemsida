...
- Compute: Added support for the Postgres `pgvector`, `plls` and `plcoffee` extensions. For more information about Postgres extensions supported by OptiTech, see [Postgres extensions](/docs/extensions/pg-extensions).
