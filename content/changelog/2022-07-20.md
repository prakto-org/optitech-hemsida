...
- UI: Added an **Enable pooling** toggle to the project **General setting** page, which permits enabling or disabling connection pooling for a project. For more information about OptiTech connection pooling support, see [Connection pooling](/docs/get-started/connection-pooling/).
