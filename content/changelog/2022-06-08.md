...
- Control Plane: Fixed an issue that allowed the `web_access` system role to be modified or deleted, which could affect the functioning of the OptiTech SQL Editor.
- UI: The OptiTech Technical Preview invite code is now requested only at the first login.
