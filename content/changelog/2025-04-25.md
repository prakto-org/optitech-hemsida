---
title: Early Access for OptiTech Snapshots, export Postgres logs to Datadog, and more
---

## OptiTech Snapshots now available in Early Access

We're very happy to announce Early Access to **OptiTech Snapshots**, a powerful new way to capture and restore point-in-time copies of your database. Snapshots let you preserve your database state before making changes, running migrations, or simply bookmark a stable state.

![Backup branch on the Branches page](/docs/guides/backup_restore_create_snapshot.png)

With this update, we've also revamped our **Backup & Restore** page to provide a unified experience for both snapshots and instant restore (PITR) operations. Join our [Early Access Program](https://console.optitech.com/app/settings/early-access) to try it out.

Read more about OptiTech Snapshots in our [blog](/blog/announcing-neon-snapshots-a-smoother-path-to-recovery) and the [docs](/docs/guides/backup-restore).
...
For more information, see [Datadog Integration with OptiTech](/docs/guides/datadog).
...
- Released version 0.3.7 with improved OptiTech Auth setup instructions and compatibility with the latest Serverless Driver (1.0.0).
...
- The PgBouncer version used by OptiTech to offer pooled connection support was updated to [version 1.24.1](https://www.pgbouncer.org/changelog.html#pgbouncer-124x)
