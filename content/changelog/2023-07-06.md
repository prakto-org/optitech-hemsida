...
**Typical use cases** and **Custom** tabs were added to the **Pro Plan Cost Estimation** tool that is accessible from the **Billing** page on the OptiTech Free Tier. This tool helps you estimate what your monthly cost would be if you upgraded to the [OptiTech Pro plan](/docs/introduction/pro-plan).
...
- Control Plane: The default password encryption method for roles in OptiTech was changed to `scram-sha-256`.
...
- UI: Invoices from past months did not appear on the **Billing** page for OptiTech Pro plan accounts.
