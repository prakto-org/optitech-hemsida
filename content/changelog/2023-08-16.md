...
### OptiTech serverless driver enhancements

The [OptiTech serverless driver](/docs/serverless/serverless-driver) is a low-latency Postgres driver for JavaScript and TypeScript that allows you to query data from serverless and edge environments over HTTP or WebSockets in place of TCP.
...
For more information, see [transaction(...) function](https://github.com/optitechdatabase/serverless/blob/main/CONFIG.md#transaction-function).
