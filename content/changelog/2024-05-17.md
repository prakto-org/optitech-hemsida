...
- Auth0, Clerk, Okta, Sequin cards on the **Integrations** page in the OptiTech Console are now linked to our documentation for those platforms. Clicking on the **Read** button on the integration card opens a documentation drawer.
...
- Fixed an issue that prevented the current endpoint status from displaying properly in the OptiTech Console.
