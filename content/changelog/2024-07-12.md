...
- **Configurable compute sizing with `-cu` option, including support for autoscaling**
  ...
  **Example:**
  ...
  Previously, compute size was determined by your default settings in the console. For more about branching via the CLI, see [OptiTech CLI commands — branches](/docs/cli/branches).
