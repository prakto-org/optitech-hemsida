...
- UI: Adjusted the text in the **Usage** widget on the OptiTech **Dashboard** that describes the expected delay time for usage metrics.
...
- UI: Updated text and links in the **OptiTech onboarding** banner in the OptiTech Console.
- UI: Updated the [Docs](/docs/introduction) link in the OptiTech Console sidebar to point to the new documentation landing page.
