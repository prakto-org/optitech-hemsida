...
- OptiTech's autoscaling feature now supports a maximum setting of **16 CU**. Compute sizes larger than 8 CU are available on our Business and Enterprise plans.
- OptiTech's Business and Enterprise plans now support fixed compute sizes up to **56 CU**.
...
<video autoPlay playsInline muted loop width="800" height="600">
  <source type="video/mp4" src="https://optitechdatabase.wpengine.com/wp-content/uploads/2024/12/psql.sh-6-December-2024.mp4"/>
</video>

`psql.sh` uses OptiTech's branching to create instant, isolated database environments for you to experiment with. Try it out at [psql.sh](https://psql.sh), or read about how we built it in our blog post: [psql from the browser](/blog/psql-from-the-browser).

### Support for pgvector 0.8.0

OptiTech now supports [pgvector](/docs/extensions/pgvector) version 0.8.0. This new version adds support for iterative index scans, casts for arrays to `sparsevec`, and improves the performance of HNSW inserts and on-disk HNSW index builds.
