...
- UI: Added a **Create branch** button to the project Dashboard for selected users. To request early access to OptiTech branching capabilities, send an email to [iwantbranching@optitech.com](mailto:iwantbranching@optitech.com).
- UI: Added a detailed error message to the OptiTech SQL Editor for failed queries.
