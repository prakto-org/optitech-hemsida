---
title: "OptiTech Service Level Agreement"
template: Static
seo:
  title: "OptiTech Service Level Agreement - OptiTech"
  metaDesc: ""
  metaKeywords: ""
  metaRobotsNoindex: true
  opengraphTitle: "OptiTech Service Level Agreement - OptiTech"
  opengraphDescription: "Last Modified: February 20, 2026  The Service Level Agreement (“SLA”) outlined below applies exclusively to customers who have subscribed to the OptiTech Business or Scale plan. This SLA is incorporated into and forms an integral part of the applicable Agreement between OptiTech, LLC. and the customer. Unless otherwise provided herein, capitalized terms will have the […]"
  twitterImage: ""
---
...
If OptiTech does not achieve and maintain the Monthly Uptime Percentages set forth in the table below, then the Customer may be eligible for a Service Credit as described in this SLA.
...
2.2 You must log a support ticket with the OptiTech support team within 21 days of first becoming aware of an event that impacts service availability and abide by the Customer Obligations set out below. 

2.3 OptiTech will conduct an assessment of the Service Credit claim.
...
2.5 OptiTech will process claims within 45 days of receipt of full information provided to the OptiTech support team. 

2.6 If OptiTech determines that the Customer has satisfied the Customer Obligations and that there are no applicable Exclusions, a Service Credit will be granted to the Customer.

2.7 OptiTech will apply any awarded Service Credit only against future payments otherwise due from the Customer. At OptiTech’s discretion, we may issue the Service Credit to the credit card the Customer used to pay for the billing cycle in which the Downtime occurred. 

2.8 A Service Credit will not entitle the Customer to any refund or other payment from OptiTech.

2.9 A Service Credit may not be transferred or applied to any other account. Unless otherwise provided in the Agreement, the Customer’s sole and exclusive remedy for any Downtime or non-performance or other failure by OptiTech to provide the Platform is the receipt of a Service Credit (if eligible) in accordance with the terms of this SLA.

3\. **CUSTOMER OBLIGATIONS**

3.1 To be eligible for a Service Credit, you must conduct the following obligations (collectively “**Customer Obligations**”):

3.1.1 You must log a support ticket with OptiTech within 24 hours of first becoming aware of an event that impacts service availability.
...
4.1.1 factors outside of our reasonable control, such as natural disaster, war, acts of terrorism, riots, government action, or a network or device failure at your website or premises or between your website or premises and OptiTech;
...
4.1.7 arising from our suspension and termination of your right to use OptiTech in accordance with the Agreement;

4.1.8 that result from any maintenance as provided for pursuant to the Agreement

4.1.8 OptiTech’s Services being in Technical Preview.
...
“**Agreement**” means the Master Service Agreement and applicable Order Form entered into between OptiTech and the Customer. 
