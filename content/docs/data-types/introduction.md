...
summary: >-
  Postgres data types hub for OptiTech, linking to dedicated guides for array,
  ...
  choosing column types or troubleshooting type-specific behavior in a OptiTech
  Postgres database.
...
Get started with commonly-used Postgres data types with OptiTech's data type guides. For other data types that Postgres supports, visit the official Postgres [Data Types](https://www.postgresql.org/docs/current/datatype.html) documentation.
