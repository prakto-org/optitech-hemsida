...
Finally, restart the compute to complete the migration. In the [OptiTech Console](https://console.optitech.com), open the compute's **⋯** menu and select **Restart compute**, or call the [Restart compute endpoint](/docs/reference/api/endpoints/restart-project-endpoint) API.
