...
summary: >-
  ...
  page to enable PostGIS on OptiTech with CREATE EXTENSION, store and query spatial
...
<Admonition type="note">
    PostGIS is an open-source extension for Postgres that can be installed on any OptiTech Project using the instructions below. Detailed installation instructions and compatibility information can be found at [PostGIS Documentation](https://postgis.net/documentation/). 
...
Please refer to the [list of all extensions](/docs/extensions/pg-extensions) available in OptiTech for up-to-date information.
