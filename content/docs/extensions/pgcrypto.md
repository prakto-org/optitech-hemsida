...
summary: >-
  ...
  standard SQL queries. The page covers enabling pgcrypto on OptiTech, all major
...
This guide covers how to enable `pgcrypto` on OptiTech, use its core cryptographic functions, and follow best practices for data security.
