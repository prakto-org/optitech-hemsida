...
summary: >-
  A category-browsable index of all Postgres extensions supported on OptiTech,
...
<a href="/docs/extensions/plv8" description="Deprecated on OptiTech. Was a Postgres procedural language powered by V8 for JavaScript callable from SQL; use plpgsql or app-side logic instead" icon="binary-code">plv8</a>
