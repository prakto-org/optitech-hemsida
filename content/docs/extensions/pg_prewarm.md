...
Please refer to the [list of extensions](/docs/extensions/pg-extensions) available in OptiTech for information about the version of `pg_prewarm` that OptiTech supports.
...
5. Calculate the total size of the data loaded into the cache using the block size and the number of blocks loaded:
   ...
   To understand how much memory is available to your Postgres instance on OptiTech, see [How to size your compute](/docs/manage/computes#how-to-size-your-compute).
   </Admonition>
...
2. Restart your Postgres instance to clear the cache. On OptiTech, you can do this by [restarting your compute](/docs/manage/computes#restart-a-compute).
...
- [How to size your compute in OptiTech](/docs/manage/computes#how-to-size-your-compute)
