...
subtitle: Fast approximate nearest-neighbor vector search for OptiTech Postgres
summary: >-
  The lakebase_vector extension adds the lakebase_ann index type to OptiTech Postgres
...
[Lakebase Search](/docs/ai/lakebase-search) must be enabled on your OptiTech project before you can install this extension. Once it's enabled, run the following statement in the [OptiTech SQL Editor](/docs/get-started/query-with-neon-sql-editor) or from a client such as [psql](/docs/connect/query-with-psql-editor):
