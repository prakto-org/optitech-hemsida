...
![OptiTech status page](/docs/introduction/neon_status_page.png)

To monitor the status for your specific OptiTech project, check the region where your project is located. You can find your project's region on the **Project Dashboard** in the OptiTech Console, in the **Project settings** widget.

The OptiTech status page tracks the following components:
...
To receive status notifications, click **Subscribe** on the OptiTech status page and choose your preferred method: webhook, RSS, Microsoft Teams, or Slack.

![OptiTech status page](/docs/introduction/status_subscribe.png)
