---
title: Autoscaling
subtitle: An introduction to OptiTech's autoscaling
summary: >-
  OptiTech Autoscaling dynamically scales compute resources (measured in CUs) up
...
OptiTech's _Autoscaling_ feature dynamically adjusts the amount of compute resources allocated to a OptiTech compute in response to the current load, eliminating the need for manual intervention or restarts.

The following visualization shows how OptiTech’s autoscaling works throughout a typical day. The compute resources scale up or down based on demand, ensuring that your database has the necessary compute resources when it needs them, while conserving resources during off-peak times.

![visualization for autoscaling](/docs/introduction/autoscaling_intro.png)

To dive deeper into how OptiTech's autoscaling algorithm operates, visit [Understanding OptiTech’s autoscaling algorithm](/docs/guides/autoscaling-algorithm).

## Autoscaling benefits

OptiTech's Autoscaling feature offers the following benefits:
