...
summary: >-
  ...
  in neon.ts, and pull branch variables locally with optitech env pull.
...
| `NEON_DATA_API_URL`                          | Data API            | Base URL for the OptiTech Data API (PostgREST). Present when the Data API is provisioned on the branch.                                                   |
