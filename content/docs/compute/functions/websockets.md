---
title: WebSockets and SSE on OptiTech Functions
subtitle: Hold long-lived connections open for real-time apps.
summary: >-
  OptiTech Functions stay alive while data flows, so they can host real-time
