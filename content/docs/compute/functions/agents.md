---
title: AI agents on OptiTech Functions
subtitle: Run streaming, tool-calling agents on OptiTech Functions.
summary: >-
  OptiTech Functions are a long-running home for AI agents. A single request can
