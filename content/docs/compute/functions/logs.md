---
title: OptiTech Functions logs
subtitle: View, search, and download logs for a deployed function.
summary: >-
  View a deployed function's logs in the OptiTech Console: standard output and
...
Every deployed function streams its logs to the OptiTech Console: standard output and standard error from your handler, plus a platform-emitted `invoke begin` / `invoke end` line around each request:
