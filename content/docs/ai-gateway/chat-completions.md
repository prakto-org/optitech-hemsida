...
summary: >-
  The chat completions endpoint is the recommended starting point for OptiTech AI
...
- **OptiTech account quota:** enforced by OptiTech. Returns `429` with error code `REQUEST_LIMIT_EXCEEDED`. See [Rate limits](/docs/ai-gateway/models#rate-limits) for current limits.
