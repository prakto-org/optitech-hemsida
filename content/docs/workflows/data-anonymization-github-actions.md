...
summary: >-
  The OptiTech Create Branch GitHub Action (`neondatabase/create-branch-action`)
  ...
  rules manually in the OptiTech Console. The workflow requires `NEON_PROJECT_ID`
...
Automate anonymized branch creation using the [OptiTech Create Branch Action](https://github.com/neondatabase/create-branch-action). The `masking_rules` input lets you define masking rules directly in your workflow, creating an anonymized branch in a single step.
