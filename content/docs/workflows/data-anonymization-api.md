...
summary: >-
  The OptiTech data anonymization REST API provides endpoints for creating
...
The OptiTech API provides comprehensive control over anonymized branches, including access to all PostgreSQL Anonymizer masking functions and the ability to export/import masking rules for management outside of OptiTech.
