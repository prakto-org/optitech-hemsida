...
summary: >-
  The OptiTech Data API works with any JWT-issuing identity system. Supply a JWKS
...
3. OptiTech validates the tokens using your provider's [JWKS (JSON Web Key Set)](https://auth0.com/docs/secure/tokens/json-web-tokens/json-web-key-sets) URL.
...
For advanced JWT configuration (custom claims, token lifespans), you can use the dedicated OptiTech template in Clerk under **Configure > JWT Templates**.
