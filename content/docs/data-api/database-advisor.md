...
summary: >-
  Data API Advisors scan your OptiTech database schema and configuration for
...
In the OptiTech Console, go to **Monitoring > Data API Advisors** for your branch. The advisor scans your database and displays any issues found, grouped by category.
...
You can also retrieve advisor issues via the [OptiTech API](/docs/reference/api/dataapi/get-project-advisor-security-issues):
...
See [OptiTech extensions](/docs/extensions/pg-extensions) for more on managing extensions.
...
If a table is repeatedly flagged for bloat, review your autovacuum settings to ensure vacuuming runs frequently enough. Contact [OptiTech support](/docs/introduction/support) for help tuning autovacuum for high-churn tables.
