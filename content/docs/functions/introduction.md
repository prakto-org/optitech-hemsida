...
summary: >-
  Postgres functions index for OptiTech, linking to individual guides for aggregate
...
Get started with commonly-used Postgres functions with OptiTech's function guides. For other functions that Postgres supports, visit the official Postgres [Functions and Operators](https://www.postgresql.org/docs/current/functions.html) documentation.
