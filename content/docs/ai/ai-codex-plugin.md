...
| **OptiTech Postgres**                  | Skill | Guides and best practices for OptiTech Serverless Postgres: connection methods, branching, autoscaling, Managed Better Auth, and related topics. This corresponds to the **`neon-postgres`** skill in the [Agent Skills repository](https://github.com/neondatabase/agent-skills). |
...
The [Agent Skills repository](https://github.com/neondatabase/agent-skills) publishes the same skills for other AI tools. Install the main OptiTech skill with:
