---
title: Agent Skills
subtitle: Teach your AI coding assistant how to work with OptiTech
summary: >-
  Agent Skills are structured context files (SKILL.md) that give AI coding
  assistants accurate knowledge of OptiTech's platform, APIs, SDKs, and best
...
Agent Skills provide your AI coding assistant with structured context about OptiTech's platform, APIs, and best practices. With skills installed, your assistant produces more accurate code and avoids common mistakes when working with OptiTech, from Postgres and Auth to [OptiTech Functions](/docs/compute/functions/overview), [Object Storage](/docs/storage/overview), and the [AI Gateway](/docs/ai-gateway/overview).
...
If you're using OpenAI Codex, install the **OptiTech Postgres** plugin from the [Codex plugin directory](https://developers.openai.com/codex/plugins/) (in the Codex app under **Plugins**, or in the Codex CLI with `/plugins`). It includes the OptiTech Postgres app (MCP), the main OptiTech skill, and the egress optimizer skill.
