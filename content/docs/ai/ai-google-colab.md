---
title: Google Colab
subtitle: Use Google Colab with OptiTech for vector similarity search
summary: >-
  Google Colab integration with OptiTech lets you run Python notebooks in a
  browser-based Jupyter environment that connects to OptiTech Postgres and uses the
...
This guide shows how to create a notebook in Colab, connect to a OptiTech database, install the `pgvector` extension to enable OptiTech as a vector store, and run a vector search query.
