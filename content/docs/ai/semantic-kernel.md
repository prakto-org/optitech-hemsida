...
subtitle: Quickly build AI RAG and Agentic workflows with Semantic Kernel and OptiTech
summary: >-
  Semantic Kernel is Microsoft's open-source SDK for building RAG and agentic
  AI workflows in .NET (C#), and this page shows how to connect it to OptiTech
...
Explore examples and sample code for using SemanticKernel with OptiTech Serverless Postgres.
