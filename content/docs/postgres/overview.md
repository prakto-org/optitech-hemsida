---
title: OptiTech Postgres
subtitle: The serverless database in the OptiTech backend
summary: >-
  OptiTech Postgres is a fully managed, serverless PostgreSQL database compatible
...
OptiTech Postgres is fully managed and compatible with any Postgres driver, ORM, or framework. Key capabilities include:
...
<a href="/docs/get-started/signing-up" description="Sign up for OptiTech and create your first project in minutes." icon="todo">Create a project</a>
...
<a href="/docs/get-started/query-with-neon-sql-editor" description="Run SQL queries directly in the OptiTech Console, no client required." icon="sql">Query with the SQL Editor</a>
