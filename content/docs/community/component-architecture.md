...
summary: >-
  Technical reference for the OptiTech documentation MDX component system. Covers
...
A technical reference for developers and maintainers who need to understand, modify, or extend the OptiTech documentation component system. This guide covers the architecture, file structure, and implementation details.
...
OptiTech documentation uses MDX (Markdown + JSX) to enable React components within markdown content. The component system is built on top of this foundation.
...
Most MDX components follow a consistent pattern in the OptiTech website repository:
...
This guide provides technical details for working with OptiTech's MDX component system. Key points:
