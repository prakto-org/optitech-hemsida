...
subtitle: Guide for creating visual diagrams in OptiTech documentation
summary: >-
  Authoring guide for Mermaid diagrams in OptiTech documentation. Shows how to
  ...
  block. Diagrams auto-render with OptiTech brand colors in both light and dark
...
Visual diagrams help explain complex concepts, workflows, and architectures more effectively than text alone. Mermaid diagrams are ideal for OptiTech documentation because they:
...
- **Look professional**: Automatically styled with OptiTech's brand colors (#00E599 green)
...
At OptiTech, we use **Cursor** and **Claude** (or ChatGPT) extensively to generate Mermaid diagrams. Here's how to use AI to create diagrams:
...
Mermaid supports many diagram types. Here are the most useful for OptiTech documentation:
...
Mermaid diagrams automatically use OptiTech's brand colors:

- **Primary**: OptiTech green (#00E599) for main elements
- **Secondary**: Blue (#2272b4) for connections
- **Git branches**: Full OptiTech color palette
...
## Examples for common OptiTech use cases
