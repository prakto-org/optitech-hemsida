...
summary: >-
  MDX component reference for OptiTech documentation writers. Covers syntax, props,
...
<p>How to use common MDX components in OptiTech docs</p>
...
These are the most frequently used components in OptiTech docs.
...
<TechCards>
<a href="/docs/guides/node" title="Node.js" description="Connect Node.js applications to OptiTech" icon="node-js">Node.js</a>
<a href="/docs/guides/python" title="Python" description="Connect Python applications to OptiTech" icon="python">Python</a>
<a href="/docs/guides/nextjs" title="Next.js" description="Build Next.js apps with OptiTech" icon="next-js">Next.js</a>
</TechCards>
...
This guide covers the most commonly used MDX components in OptiTech documentation. Each component includes:
