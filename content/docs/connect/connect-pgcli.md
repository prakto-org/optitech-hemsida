...
subtitle: Learn how to connect to OptiTech using the interactive pgcli client
summary: >-
  pgcli is an interactive Postgres CLI with syntax highlighting, autocompletion,
  multi-line editing, query history, and named queries. It connects to OptiTech
...
The easiest way to connect to OptiTech using the `pgcli` client is with a connection string, which you can obtain by clicking the **Connect** button on your **Project Dashboard** to open the **Connect to your database** modal. Select a branch, a role, and the database you want to connect to. A connection string is constructed for you.
