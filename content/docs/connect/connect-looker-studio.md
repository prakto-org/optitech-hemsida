---
title: Connect Looker Studio to OptiTech
subtitle: Learn how to connect your OptiTech Postgres database to Looker Studio
summary: >-
  Looker Studio connects to OptiTech Postgres through Google's built-in PostgreSQL
  ...
  this page when adding OptiTech as a Looker Studio data source for dashboards and
...
1. Download the `isrgrootx1.pem` file from https://letsencrypt.org/certs/isrgrootx1.pem. For more information about SSL certificates, see [Connect to OptiTech securely](/docs/connect/connect-securely).
