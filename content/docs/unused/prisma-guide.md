---
title: Use Prisma with OptiTech
subtitle: Follow this step-by-step guide to learn how to use Prisma with OptiTech
...
This guide steps you through how to connect from Prisma to OptiTech, how to use Prisma Migrate to create and evolve a schema, how to add data using the OptiTech SQL Editor or Prisma Studio, how to send queries using Prisma Client, and finally, how to introspect an existing database using the Prisma CLI.

## Create a OptiTech project and copy the connection string

1. In the OptiTech Console, click **Create a project** to open the **Project Creation** dialog.
...
For cloud-hosted databases like OptiTech, you must create the shadow database manually. To create the shadow database:
...
You have a couple of options for adding data to the `Elements` table. You can add data using the OptiTech SQL Editor or with Prisma Studio. Both methods are described below.
...
## Send queries to your OptiTech database with Prisma Client
