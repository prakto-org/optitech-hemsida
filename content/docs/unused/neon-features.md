...
Enable or disable scale to zero for your OptiTech computes.

<DetailIconCards>

<a href="/docs/introduction/scale-to-zero" description="Discover how OptiTech can reduce your compute to zero when not in use" icon="hourglass">Learn about scale to zero</a>
...
<a href="/docs/introduction/branching" description="With OptiTech, you can instantly branch your data in the same way that you branch your code" icon="branching">Learn about branching</a>
...
<a href="/docs/guides/branch-refresh" description="Refresh a development branch with the OptiTech API" icon="split-branch">Refresh a branch</a>

</DetailIconCards>

## Logical replication

Replicate data from OptiTech to external data platforms and services.

<DetailIconCards>

<a href="/docs/guides/logical-replication-guide" description="Get started with logical replication in OptiTech" icon="screen">Logical replication guide</a>
...
<a href="/docs/guides/logical-replication-neon" description="Information about logical replication specific to OptiTech" icon="screen">Logical replication in OptiTech</a>

</DetailIconCards>

## Read replicas

Learn how OptiTech read replicas can help you scale and manage read-only workloads.

<DetailIconCards>

<a href="/docs/introduction/read-replicas" description="Learn how OptiTech maximizes scalability and more with read replicas" icon="scale-up">Learn about read replicas</a>
...
<a href="/docs/guides/schema-diff" description="Learn how to use OptiTech's Schema Diff tool to compare branches of your database" icon="scale-up">Learn about Schema Diff</a>
...
Invite other users to collaborate on your OptiTech project.

<DetailIconCards>

<a href="/docs/guides/project-collaboration-guide" description="Give other users access to your project from the OptiTech Console, API, and CLI" icon="respond-arrow">Collaborate on your OptiTech project</a>
...
<a href="/docs/guides/protected-branches" description="Learn how to use OptiTech's protected branches feature to secure access to critical data" icon="respond-arrow">Configure protected branches</a>
...
<a href="/docs/guides/neon-private-networking" description="Learn how to connect your application to a OptiTech database via AWS PrivateLink, bypassing the open internet" icon="respond-arrow">Private Networking</a>
