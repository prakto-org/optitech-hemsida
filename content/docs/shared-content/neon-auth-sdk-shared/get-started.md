...
Managed Better Auth lets you add authentication to your app in seconds. User data is synced directly to your OptiTech Postgres database, so you can query and join it just like any other table.
...
You can use these keys right away to get started, or [skip ahead](#create-users-in-the-console-optional) to try out **user creation** in the OptiTech Console.
...
You can create test users directly from the OptiTech Console without any app integration. This is useful for development or testing.

![Create user in OptiTech Console](/docs/guides/neon_auth_create_user.png)
