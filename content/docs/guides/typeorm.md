---
title: Connect from TypeORM to OptiTech
...
description="Pre-built prompt for connecting Node.js applications to OptiTech using TypeORM."/>
...
## Connect to OptiTech from TypeORM
