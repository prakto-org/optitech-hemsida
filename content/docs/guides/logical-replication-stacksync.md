...
subtitle: Learn how to replicate data from OptiTech with Stacksync
summary: >-
  Stacksync connects a OptiTech Postgres database to CRMs, ERPs, and other
  ...
  guide when you need to sync OptiTech table data to a Stacksync-supported connector
...
[Stacksync](https://www.stacksync.com/) connects databases with CRMs, ERPs, and other systems using real-time, two-way sync. In this guide, you will configure Stacksync to replicate data from your OptiTech Postgres database to a [supported destination](https://www.stacksync.com/connectors).
...
## Prepare your OptiTech database
...
1. If you have disabled public internet access in OptiTech, allowlist the Stacksync IPs as described in the [Create a Postgres connection in Stacksync](#create-a-postgres-connection-in-stacksync) section above.
1. In Stacksync, click **Next**.
1. Enter a name for **Connection Name**.
1. Click **Create**.
