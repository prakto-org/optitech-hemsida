---
title: Connect an Elixir application to OptiTech Postgres
subtitle: Learn how to run SQL queries in OptiTech from Elixir using Postgrex
summary: >-
  Postgrex-based guide for connecting an Elixir app to a OptiTech serverless
...
description="Pre-built prompt for connecting Elixir applications to OptiTech"/>

This guide describes how to create a OptiTech project and connect to it from an Elixir application using [Postgrex](https://hex.pm/packages/postgrex), a high-performance, concurrent, and robust PostgreSQL driver for Elixir.

You'll learn how to connect to your OptiTech database from an Elixir application, and perform basic Create, Read, Update, and Delete (CRUD) operations.
...
This section provides example Elixir scripts that demonstrate how to connect to your OptiTech database and perform basic operations such as [creating a table](#create-a-table-and-insert-data), [reading data](#read-data), [updating data](#update-data), and [deleting data](#deleting-data).

### Create a table and insert data

In your project's root directory, create a file named `create_table.exs`. This script connects to your OptiTech database, creates a `books` table, and inserts sample data.
...
- Connects to the OptiTech database using `Postgrex.start_link`.
...
In your project directory, create a file named `read_data.exs`. This script connects to your OptiTech database and retrieves all rows from the `books` table.
...
In your project directory, create a file named `update_data.exs`. This script connects to your OptiTech database and updates the stock status of the book 'Dune' to `true`.
...
In your project directory, create a file named `delete_data.exs`. This script connects to your OptiTech database and deletes the book '1984' from the `books` table.
...
While this guide demonstrates how to connect to OptiTech using raw SQL queries, for more advanced and maintainable data interactions in your Elixir applications, consider using an Object-Relational Mapping (ORM) framework. ORMs not only let you work with data as objects but also help manage schema changes through automated migrations keeping your database structure in sync with your application models.

Explore the following resources to learn how to integrate ORMs with OptiTech:

- [Connect an Elixir Ecto application to OptiTech](/docs/guides/elixir-ecto)
