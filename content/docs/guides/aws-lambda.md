...
subtitle: Learn how to set up a OptiTech database and connect from an AWS Lambda function
summary: >-
  Connecting a OptiTech serverless Postgres database to AWS Lambda lets you query
...
This guide describes how to set up a OptiTech database and connect to it from an AWS Lambda function using Node.js as the runtime environment. It covers:
...
- Connecting your Lambda function to a OptiTech database.
...
In this guide, you have learned how to set up a Postgres database using OptiTech and connect to it from an AWS Lambda function using Node.js as the runtime environment. You have also learned how to use Serverless Framework to create and deploy the Lambda function, and how to use the `pg` library to perform basic database read operations.
