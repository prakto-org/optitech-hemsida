---
title: Chat with OptiTech Postgres with AskYourDatabase
subtitle: Chat with your OptiTech Postgres database without writing SQL
summary: >-
...
This guide shows how to connect from AskYourDatabase to OptiTech Postgres.
...
## Connect to OptiTech from AskYourDatabase
...
![Chat with OptiTech](/docs/guides/askyourdatabase_ask_neon.png)

## What's more

AskYourDatabase also supports a customer-facing chatbot that can connect to a OptiTech Postgres database. You can embed the chatbot in your existing website, enabling your customers to explore analytics data by asking questions in natural language. To learn more, see [Create and Integrate Chatbot](https://www.askyourdatabase.com/docs/chatbot), in the AskYourDatabase documentation.
