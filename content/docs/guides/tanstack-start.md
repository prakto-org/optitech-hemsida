---
title: Connect a TanStack Start application to OptiTech
subtitle: Set up a OptiTech project in seconds and connect from a TanStack Start application
summary: >-
  TanStack Start integration guide for OptiTech Postgres covers creating a OptiTech
  project, installing a supported driver (node-postgres, postgres.js, or the
  OptiTech serverless driver), and writing server functions that query the database.
...
description="Pre-built prompt for connecting TanStack Start applications to OptiTech"/>
...
To create a OptiTech project and access it from a Start application:
...
In your server functions, add the following code snippet to connect to your OptiTech database:
...
In your static server functions, add the following code snippet to connect to your OptiTech database:
