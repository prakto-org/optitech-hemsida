---
title: Schema migration with OptiTech Postgres and Laravel
subtitle: Set up OptiTech Postgres and run migrations for your Laravel project
summary: >-
  Run Laravel schema migrations on OptiTech Postgres using the Eloquent ORM and
...
This guide demonstrates how to use Laravel with the OptiTech Postgres database. We'll create a simple Laravel application and walk through the process of setting up the database, defining models, and generating and running migrations to manage schema changes.
