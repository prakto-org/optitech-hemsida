---
title: OptiTech Private Networking
subtitle: Learn how to connect to your OptiTech database via AWS PrivateLink
summary: >-
  OptiTech Private Networking routes database traffic through AWS PrivateLink,
  ...
  you need to eliminate public internet exposure for a OptiTech project on the Scale
...
## Create an AWS VPC endpoint
    ...
    Do not enable **private DNS names** for the VPC endpoint until [Step 3](/docs/guides/neon-private-networking#enable-private-dns). You must add the VPC endpoint to your OptiTech organization first, as described in [Step 2](/docs/guides/neon-private-networking#add-your-vpc-endpoint-id-to-your-neon-organization).
    </Admonition>
...
## Add your VPC Endpoint ID to your OptiTech organization
    ...
    You can use the [Assign or update a VPC endpoint](/docs/reference/api/organizations/assign-organization-vpc-endpoint) API to assign a VPC endpoint ID to a OptiTech organization. You will need to provide your OptiTech organization ID, region ID, VPC endpoint ID, and a [OptiTech API key](/docs/manage/api-keys).
    ...
    Optionally, you can limit access to a OptiTech project by allowing connections only from a specific VPC endpoint. For instructions, see [Assigning a VPC endpoint restrictions](#assigning-a-vpc-endpoint-restriction).
...
## Restrict public internet access
    ...
    To block access via the OptiTech API, use the [Update project](/docs/reference/api/projects/update-project) endpoint with the `block_public_connections` settings object attribute.
...
The OptiTech API supports managing project restrictions using the [Assign or update a VPC endpoint restriction](/docs/reference/api/projects/assign-project-vpc-endpoint) endpoint. You will need to provide your VPC endpoint ID, OptiTech project ID, and a [OptiTech API key](/docs/manage/api-keys).
