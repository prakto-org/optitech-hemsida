...
summary: >-
  ...
  OptiTech serverless driver (@neon/serverless on JSR) for both local Deno Runtime
...
This guide demonstrates how to connect to a OptiTech Postgres database from a simple Deno application using the [OptiTech serverless driver](https://jsr.io/@neon/serverless) on [JSR](https://jsr.io/).
...
- A OptiTech project. If you do not have one, sign up at [Neon](https://neon.tech). Your Neon project comes with a ready-to-use Postgres database named `neondb`. We'll use this database in the following examples.
...
- [OptiTech Serverless Driver](https://jsr.io/@neon/serverless)
- [JSR](https://jsr.io/)
