---
title: Connect an Express application to OptiTech
...
description="Pre-built prompt for connecting ExpressJS applications to OptiTech Postgres"/>

This guide describes how to create a OptiTech project and connect to it from an Express application.
...
Add an `index.js` file to your project directory and add the following code snippet to connect to your OptiTech database:
