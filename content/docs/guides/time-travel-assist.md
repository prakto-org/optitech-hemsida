...
summary: >-
  Time Travel in OptiTech lets you run read-only queries against any point in time
...
1. In the OptiTech Console, open the branch's **Backup & Restore** page and go to **Restore from history**.
...
- Ephemeral endpoints are created with a .50 CU compute size (2 GB of RAM). This is OptiTech's second smallest compute size. For more about compute sizes in OptiTech, see [How to size your compute](/docs/manage/computes#how-to-size-your-compute).
