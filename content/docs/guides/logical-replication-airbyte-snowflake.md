...
This section describes how to prepare your source OptiTech database (the publisher) for replicating data.
...
You can verify that logical replication is enabled by running the following query from the [OptiTech SQL Editor](/docs/get-started/query-with-neon-sql-editor) or an SQL client such as [psql](/docs/connect/query-with-psql-editor):
...
2. Enter the connection details for your OptiTech database. You can find your database connection details by clicking the **Connect** button on your **Project Dashboard**.
...
In this step, you'll set up a connection between your OptiTech Postgres source and your Snowflake destination.
