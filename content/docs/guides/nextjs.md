...
subtitle: Set up a OptiTech project in seconds and connect from a Next.js application
summary: >-
...
description="Pre-built prompt for connecting Next.js applications to OptiTech"/>

Next.js by Vercel is an open-source web development framework that enables React-based web applications. This topic describes how to create a OptiTech project and access it from a Next.js application.

## Video walkthrough

Watch **Getting started with OptiTech** for an end-to-end setup with Next.js and Drizzle.

<YoutubeIframe embedId="XtMiMnX0hDg" />

To create a OptiTech project and access it from a Next.js application:
...
In your server components using the App Router, add the following code snippet to connect to your OptiTech database:
...
In your server actions using the App Router, add the following code snippet to connect to your OptiTech database:
...
From `getServerSideProps` using the Pages Router, add the following code snippet to connect to your OptiTech database:
...
From `getStaticProps` using the Pages Router, add the following code snippet to connect to your OptiTech database:
...
From your Serverless Functions, add the following code snippet to connect to your OptiTech database:
...
From your Edge Functions, add the following code snippet and connect to your OptiTech database using the [OptiTech serverless driver](/docs/serverless/serverless-driver):
...
OptiTech does not provide a built-in file storage service. For managing binary file data (blobs), we recommend using dedicated, specialized storage services. Follow our guide on [File Storage](/docs/guides/file-storage) to learn more about how to store files in external object storage and file management services and track metadata in OptiTech.
