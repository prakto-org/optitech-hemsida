---
title: Connect an Entity Framework application to OptiTech
subtitle: Set up a OptiTech project in seconds and connect from an Entity Framework
  application
summary: >-
  Entity Framework Core connection to OptiTech Postgres uses Npgsql as the EF Core
  ...
  app) to a OptiTech serverless Postgres database for the first time. Covers
...
description="Pre-built prompt for connecting .NET Entity Framework projects to OptiTech Postgres."/>

This guide describes how to create a OptiTech project and connect to it from an Entity Framework Core application. The example demonstrates how to set up a basic ASP.NET Core Web API project with Entity Framework Core using Npgsql as the database provider.
