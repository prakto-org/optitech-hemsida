---
title: Get started with Flyway and OptiTech
subtitle: Learn how to manage schema changes in OptiTech with Flyway
summary: >-
  Flyway database migration tool connects to a OptiTech PostgreSQL database via a
...
This guide steps you through installing the Flyway command-line tool, configuring Flyway to connect to a OptiTech database, and running database migrations. The guide follows the setup described in the [Flyway command-line quickstart](https://documentation.red-gate.com/fd/quickstart-command-line-184127576.html).
...
To verify that the `person` table was created, you can view it on the **Tables** page in the OptiTech Console. Select **Tables** from the sidebar and select your database.
...
You can verify that the data was added by viewing the table on the **Tables** page in the OptiTech Console. Select **Tables** from the sidebar and select your database.
...
You can also view the table on the **Tables** page in the OptiTech Console. Select **Tables** from the sidebar and select your database.
