---
title: Connect from Phoenix to OptiTech
subtitle: Set up a OptiTech project in seconds and connect from Phoenix
summary: >-
  Connecting a Phoenix (Elixir) application to OptiTech requires configuring Ecto
  ...
  setting up a new or existing Phoenix project with OptiTech, covering project
...
description="Pre-built prompt for connecting Phoenix applications to OptiTech Postgres"/>

This guide describes how to connect OptiTech in a [Phoenix](https://www.phoenixframework.org) application. [Ecto](https://hexdocs.pm/ecto/3.11.2/Ecto.html) provides an API and abstractions for interacting databases, enabling Elixir developers to query any database using similar constructs.
...
Update the following configuration files with your OptiTech database connection details from the connection string you copied earlier.
