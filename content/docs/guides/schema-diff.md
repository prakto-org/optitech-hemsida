---
title: Schema diff
subtitle: Learn how to use OptiTech's Schema Diff tool to compare branches of your database
summary: >-
...
Schema Diff is available in the OptiTech Console for use in two ways:
...
You can launch the Schema Diff viewer from the **Branches** and **Restore** pages in the OptiTech Console.
