---
title: Connect from Symfony with Doctrine to OptiTech
...
description="Pre-built prompt for connecting Symfony applications to OptiTech using Doctrine ORM."/>

Symfony is a free and open-source PHP web application framework. Symfony uses the Doctrine library for database access. Connecting to OptiTech from Symfony with Doctrine is the same as connecting to a standalone Postgres installation from Symfony with Doctrine. Only the connection details differ.

To connect to OptiTech from Symfony with Doctrine:
