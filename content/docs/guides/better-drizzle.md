---
title: Connect from Better Drizzle to OptiTech
subtitle: Learn how to connect to OptiTech from Better Drizzle
summary: >-
  Better Drizzle connection guide for OptiTech Postgres walks through setting up
...
<p>How to set up better-drizzle with OptiTech Postgres</p>
...
To connect a TypeScript/Node.js project to OptiTech using better-drizzle, follow these steps:
...
Apply the generated SQL migrations to your OptiTech database:
...
- [OptiTech Drizzle setup guide](/docs/guides/drizzle)
- [Schema migration with OptiTech and Drizzle](/docs/guides/drizzle-migrations)
