...
summary: >-
  ...
  OptiTech account or need direct billing control. The two integrations cannot
  coexist in the same Vercel project, and each OptiTech project maps to exactly one
...
![Install on Existing OptiTech Account](/docs/guides/vercel_install_neon_modal_existing_account.png)
...
![Add OptiTech from Connectable Accounts](/docs/guides/vercel_add_connected_neon_account.png)
</Admonition>
...
![Connect OptiTech Account Projects](/docs/guides/vercel_connect_neon_account_projects.png)
