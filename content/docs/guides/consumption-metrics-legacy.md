...
summary: >-
  The legacy OptiTech consumption API provides the `/consumption_history/projects`
...
For full parameter and response details, see [Retrieve project consumption metrics](/docs/reference/api/consumption/get-consumption-history-per-project) in the OptiTech API Reference.
