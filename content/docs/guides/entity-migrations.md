---
title: Schema migration with OptiTech Postgres and Entity Framework
subtitle: Set up OptiTech Postgres and run migrations for your Entity Framework project
summary: >-
  Entity Framework Core schema migrations on OptiTech Postgres walks through
...
This guide demonstrates how to use Entity Framework with the OptiTech Postgres database. We'll create a simple .NET application and walk through the process of setting up the database, defining models, and generating and running migrations to manage schema changes.
...
To apply the migration and create the tables in the OptiTech Postgres database, run the following command:
...
In this guide, we demonstrated how to set up an Entity Framework project with OptiTech Postgres, define data models, generate migrations, and run them. Entity Framework's migration system make it easy to interact with the database and manage schema evolution over time.
