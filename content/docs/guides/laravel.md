---
title: Connect from Laravel to OptiTech
subtitle: Set up a OptiTech project in seconds and connect from a Laravel application
summary: >-
  Connect a Laravel application to OptiTech Postgres by setting the DB_CONNECTION,
...
description="Pre-built prompt for connecting Laravel to OptiTech Postgres"/>
...
<a href="/docs/guides/laravel-migrations" description="Schema migration with OptiTech Postgres and Laravel" icon="app-store" icon="app-store">Laravel Migrations</a>
