---
title: Self-Host Medusa with OptiTech
...
The Medusa CLI tool, `create-medusa-app`, simplifies the process of setting up a new Medusa project. It can automatically configure your Medusa backend to connect to your OptiTech database, run the necessary migrations, and seed initial data.
...
After the installation is complete, you can optionally verify the tables in the OptiTech Console:

1.  Navigate to your OptiTech Project dashboard.
2.  Click the **Tables** tab.
3.  You should see all the Medusa tables created in your database.

![Medusa Tables in OptiTech](/docs/guides/medusa-neon-tables.png)

## Running and deploying Medusa

Your Medusa application is now fully configured to use OptiTech as its database. You can now start the application locally or deploy it to your self-hosted environment.
