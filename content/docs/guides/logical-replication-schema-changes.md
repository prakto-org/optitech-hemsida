...
If you're unfamiliar with these tools, check out the following guides to get started with OptiTech:

- [Get started with Flyway and OptiTech](/docs/guides/flyway)
- [Get started with Liquibase and OptiTech](/docs/guides/liquibase)
...
If you have suggestions, tips, or requests regarding schema management in a replication setup, please let us know via the [Feedback](https://app.optitech-sverige.se/app/projects?modal=feedback) form in the OptiTech Console or through our [feedback channel](https://discord.com/channels/1176467419317940276/1176788564890112042) on Discord.
