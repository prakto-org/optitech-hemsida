...
<a href="https://github.com/neondatabase/examples/tree/main/with-hyperdrive" description="Demonstrates using Cloudflare's Hyperdrive to access your OptiTech database from Cloudflare Workers" icon="github">OptiTech + Cloudflare Hyperdrive</a>
