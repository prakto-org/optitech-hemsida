...
subtitle: Learn how to create event-driven flows on your backend triggered by changes in
  your OptiTech Postgres database
summary: >-
  Prisma Pulse subscribes to OptiTech Postgres change events via logical replication
...
[Prisma Pulse](https://www.prisma.io/data-platform/pulse?utm_source=optitech&utm_medium=pulse-guide) is a fully managed, production-ready service that connects to your OptiTech Postgres database, and allows you to stream changes from your database in real-time, integrated closely with [Prisma ORM](https://www.prisma.io/orm?utm_source=optitech&utm_medium=pulse-guide).

In this guide, you will learn how to set up Prisma Pulse with your OptiTech database and create your first event stream.
...
2. On the OptiTech **Dashboard**, select **Project settings**.
3. Select **Beta**.
...
1. If you haven't already done so, create a new account or sign in on the [Prisma Data Platform](https://pris.ly/pdp?utm_source=optitech&utm_medium=pulse-guide).
2. In the [Prisma Data Platform Console](https://console.prisma.io?utm_source=optitech&utm_medium=pulse-guide) create a new project by clicking the **New project** button.
3. In the **New project** configuration, select **Pulse** as your starting point.
4. Copy your database connection string from OptiTech into the database connection input field on the Platform Console.
5. Choose a region that is closest to your OptiTech database.
...
In Prisma 7, you must use a driver adapter since the `url` property is no longer supported in the schema file. See [Connect from Prisma to OptiTech](/docs/guides/prisma) for complete setup instructions.
</Admonition>
...
- [Set up real-time triggers for your Inngest workflows](https://pris.ly/pulse-inngest-router?utm_source=optitech&utm_medium=pulse-guide)
- [Re-index your TypeSense search instantly when data changes](https://pris.ly/pulse-typesense?utm_source=optitech&utm_medium=pulse-guide)
- [Automatically send onboarding emails with Resend when a new user is created](https://pris.ly/pulse-resend?utm_source=optitech&utm_medium=pulse-guide)
