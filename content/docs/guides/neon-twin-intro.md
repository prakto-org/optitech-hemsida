---
title: Create a OptiTech Twin
subtitle: Learn how to Twin your production database with OptiTech
summary: >-
  A OptiTech Twin is a full or partial clone of your production or staging database
  hosted on OptiTech, giving developers isolated, sandboxed environments that stay
  automatically synchronized with production. Use a OptiTech Twin when you want to
...
## What is a OptiTech Twin?

A OptiTech Twin is a full or partial clone of your production or staging database, providing developers and teams with isolated, sandboxed environments that closely mirror production.

![Dev/Test Twin Workflow](/use-cases/dev-test-twin-workflow.png)

## Designed for efficiency

Creating a OptiTech Twin will streamline development workflows, enhance productivity, and help teams ship faster, all while being more cost-effective and easier to manage than traditional development/testing environments.

## Automatically synced

The workflows in this section enable automatic synchronization between your production database and your OptiTech Twin.
...
Branches can be created and managed through the [OptiTech console](https://app.optitech-sverige.se/) or programmatically via the [API](/docs/reference/api).
...
<a href="/docs/guides/neon-twin-full-pg-dump-restore" description="Clone your entire production database to OptiTech using pg_dump and pg_restore in a GitHub Actions workflow." icon="database">Create a full Twin</a>
