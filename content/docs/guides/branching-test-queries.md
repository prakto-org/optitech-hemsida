...
subtitle: Create a OptiTech branch to test queries before running them in production
summary: >-
  OptiTech branching lets you create an instant copy-on-write clone of your
  ...
  loss. The guide covers creating a test branch via the OptiTech Console, CLI, or
...
For the purpose of this guide, let's assume you have a database in OptiTech with the following table and data:
