...
subtitle: Learn how to query project consumption metrics for usage-based plans using the
  OptiTech API
summary: >-
  The OptiTech consumption metrics API (/consumption_history/v2) returns
