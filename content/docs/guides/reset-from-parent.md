...
summary: >-
  Reset from parent instantly overwrites all databases on a OptiTech child branch
...
<TabItem>
On the **Branches** page in the OptiTech Console, select the branch that you want to reset.
