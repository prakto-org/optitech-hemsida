...
If you simply want OptiTech and Vercel with minimal setup, stick to the managed integrations. They're simpler and include UI support.

---

## Prerequisites

- OptiTech project with database (get a connection string via **Connect** in the Console)
...
That's it. Your Vercel app now connects to OptiTech just like any other Postgres database.
