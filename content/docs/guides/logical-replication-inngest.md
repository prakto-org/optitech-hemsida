...
subtitle: Learn how to replicate data from OptiTech with Inngest
summary: >-
  Inngest's native OptiTech integration uses Postgres logical replication to convert
  ...
  need to forward OptiTech Postgres changes to third-party destinations like
  Amplitude or S3 without writing a custom replication consumer. Setup requires
  enabling logical replication in the OptiTech console and supplying admin
...
You can find your admin OptiTech database connection credentials by clicking the **Connect** button on your **Project Dashboard** to open the **Connect to your database** modal. For details, see [Connect from any application](/docs/connect/connect-from-any-app).
