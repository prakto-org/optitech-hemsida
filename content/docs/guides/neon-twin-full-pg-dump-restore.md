...
summary: >-
  Full OptiTech Twin workflow that copies a complete production database into a OptiTech
...
To use this workflow, you'll need the Postgres connection string for your OptiTech database. Follow our [Getting Started Guide](/docs/get-started/signing-up#sign-up) to learn how.
</Admonition>

<Admonition type="important">
Avoid using `pg_dump` over a [pooled connection string](/docs/reference/glossary#pooled-connection-string). Use an [unpooled connection string](/docs/reference/glossary#unpooled-connection-string) for `PROD_DATABASE_URL` and `DEV_DATABASE_URL` when they point to OptiTech.
</Admonition>
...
- `DEV_DATABASE_URL`: The PostgreSQL connection string for your OptiTech database.
...
To manually trigger your workflow go to **Actions** > **Create OptiTech Twin** then click **Run workflow**. From the dropdown, click the **Run workflow** button.
