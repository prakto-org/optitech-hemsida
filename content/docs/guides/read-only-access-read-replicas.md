...
summary: >-
  OptiTech read replicas let you grant read-only database access to partners,
...
1. **Create a read replica**
   ...
   - In the OptiTech Console, go to **Branches**.
...
2. **Provide the connection string**
   ...
   Once the read replica is created, obtain the connection string from the OptiTech Console:
