---
title: Connect from Prisma to OptiTech
...
- **Pooled connection (`DATABASE_URL`)**: Your application connects through OptiTech's connection pooler, which is optimal for serverless functions that create many short-lived connections.
...
- [OptiTech serverless driver](/docs/serverless/serverless-driver): Learn more about the driver powering the adapter
