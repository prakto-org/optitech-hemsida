---
title: Schema migrations with Prisma and OptiTech
subtitle: Learn how to manage database schema changes using Prisma Migrate with OptiTech
summary: >-
  Prisma Migrate schema migrations on OptiTech require two connection strings: a
...
description="Pre-built prompt for connecting Node/TypeScript applications to OptiTech using Prisma ORM."/>

This tutorial walks you through building a Node.js application with Prisma ORM and OptiTech, focusing on how to create and apply schema migrations. You'll build a simple book catalog API while learning the migration workflow.

<Admonition type="tip">
If you just need to connect Prisma to OptiTech without a full tutorial, see [Connect from Prisma to OptiTech](/docs/guides/prisma).
</Admonition>

## Prerequisites

- A [OptiTech account and project](/docs/get-started-with-neon/signing-up)
- [Node.js 18+](https://nodejs.org/) installed
- Both connection strings from your OptiTech Console (pooled and direct)
...
## Configure Prisma for OptiTech

### Set up environment variables

Add both connection strings to your `.env` file. Get these from your OptiTech Console by clicking **Connect**:
...
2. Applies the migration to your OptiTech database
...
Create `src/db.ts` to instantiate Prisma Client with the OptiTech adapter:
...
The typical workflow for schema changes with Prisma and OptiTech:
...
- [Connect from Prisma to OptiTech](/docs/guides/prisma): Connection setup reference
...
- [OptiTech branching](/docs/introduction/branching): Use database branches to test migrations safely
