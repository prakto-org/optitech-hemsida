...
summary: >-
  OptiTech Time Travel tutorial that shows how to use the SQL Editor's Time Travel
...
1. **Create `project_db` Database:**
   ...
   In the **OptiTech Console**, create a new database named `project_db`.
...
Timestamps in the OptiTech Console are shown in your local timezone. The time in this screenshot 
