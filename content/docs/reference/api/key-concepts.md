...
summary: >-
  ...
  constraints before building automation with the OptiTech API.
enableTableOfContents: true
---

Review these API behavior notes before you build scripts, CI/CD workflows, or control-plane integrations on top of OptiTech.

## Asynchronous operations

Many OptiTech API operations, including creating branches and starting computes, are asynchronous. The API response includes an `operations` array with status information:
