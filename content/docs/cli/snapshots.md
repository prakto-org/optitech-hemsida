---
title: 'OptiTech CLI command: snapshots'
subtitle: 'Create, list, restore, and schedule branch snapshots from the terminal'
summary: >-
  The OptiTech CLI `snapshots` command provides subcommands (create, list, get,
  update, delete, restore, finalize, schedule) to manage point-in-time
  snapshots of your OptiTech branches. Use this reference for exact flags and
...
## optitech snapshots create (#create)
...
## optitech snapshots update (#update)
...
## optitech snapshots delete (#delete)
...
## optitech snapshots restore (#restore)
...
## optitech snapshots finalize (#finalize)
...
### optitech snapshots schedule get (#schedule-get)
...
### optitech snapshots schedule set (#schedule-set)
