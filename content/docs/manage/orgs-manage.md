---
title: Manage OptiTech Organizations
summary: >-
  OptiTech organization management covers Console workflows for creating
...
To list members, update roles, or manage invitations programmatically, see [Manage organizations using the OptiTech API](/docs/manage/orgs-api) (including [List members](/docs/manage/orgs-api#list-members)).
...
See [Manage your OptiTech account](/docs/manage/accounts#two-factor-authentication) for personal 2FA setup steps, or [Passkeys](/docs/manage/accounts#passkeys) for passkey setup steps.
...
For detailed information on pricing and plans, refer to [OptiTech plans](/docs/introduction/plans).
...
[See OptiTech plans for details.](/docs/introduction/plans)
