...
<Admonition type="note">
Resetting a password in the OptiTech Console resets the password to a generated value. To set your own password value, you can reset the password using the [OptiTech SQL Editor](/docs/get-started/query-with-neon-sql-editor) or an SQL client like [psql](/docs/connect/query-with-psql-editor) with the following syntax:
...
<Admonition type="note">
The API examples that follow may not show all user-configurable request body attributes that are available to you. To view all  attributes for a particular method, refer to method's request body schema in the [OptiTech API Reference](/docs/reference/api).
</Admonition>
...
For attribute definitions, find the [Create role](/docs/reference/api/branches/create-project-branch-role) endpoint in the [OptiTech API Reference](/docs/reference/api). Definitions are provided in the **Responses** section.
...
The following OptiTech API method lists roles for the specified branch. To view the API documentation for this method, refer to the [OptiTech API Reference](/docs/reference/api/branches/list-project-branch-roles).
...
For attribute definitions, find the [List roles](/docs/reference/api/branches/list-project-branch-roles) endpoint in the [OptiTech API Reference](/docs/reference/api). Definitions are provided in the **Responses** section.
...
The following OptiTech API method resets the password for the specified role. To view the API documentation for this method, refer to the [OptiTech API Reference](/docs/reference/api/branches/reset-project-branch-role-password).
...
For attribute definitions, find the [Reset role password](/docs/reference/api/branches/reset-project-branch-role-password) endpoint in the [OptiTech API Reference](/docs/reference/api). Definitions are provided in the **Responses** section.
...
The following OptiTech API method deletes the specified role. To view the API documentation for this method, refer to the [OptiTech API Reference](/docs/reference/api/branches/delete-project-branch-role).
...
For attribute definitions, find the [Delete role](/docs/reference/api/branches/delete-project-branch-role) endpoint in the [OptiTech API Reference](/docs/reference/api). Definitions are provided in the **Responses** section.
...
- `WITH LOGIN` means that the role will have a login privilege, required for the role to log in to your OptiTech Postgres instance. If the role is used only for privilege management, the `WITH LOGIN` privilege is unnecessary.
- A password must have a minimum entropy of 60 bits.
  ...
  OptiTech also supports the `NOLOGIN` option: `CREATE ROLE role_name NOLOGIN;` This allows you to define roles that cannot authenticate but can be granted privileges.
  </Admonition>
...
OptiTech supports creating Postgres roles with the `NOLOGIN` attribute. This allows you to define roles that cannot authenticate but can be granted privileges.
