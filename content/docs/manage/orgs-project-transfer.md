...
- Projects can only be transferred to organizations you belong to, not to personal OptiTech accounts.
...
You can also transfer projects from one org to another using the OptiTech API:
...
You can verify the transfer in the OptiTech Console or by listing the projects in the destination organization via API.
