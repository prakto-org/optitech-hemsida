---
title: Manage organizations using the OptiTech API
summary: >-
  OptiTech Organization API endpoints for managing org API keys, members,
...
- If they have an existing OptiTech account, they automatically join as a member
