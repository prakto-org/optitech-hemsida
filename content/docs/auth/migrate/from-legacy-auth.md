...
- **Database as Source of Truth**
  ...
  Your OptiTech database is the single source of truth for authentication data. No webhooks, no sync delays, no external dependencies. Query users directly with SQL.
...
**What changed**  
You replace multiple Stack Auth-specific keys with a single Better Auth URL that points at your OptiTech project. For Next.js, you also need a cookie secret for session caching.
...
**What changed**  
You use the framework-agnostic OptiTech JS SDK plus the shared UI package instead of the Stack Auth client SDK.
...
## Claim your project via the OptiTech Console

1. Go to your project's **Auth** page, **Configuration** tab in the OptiTech Console.
...
Ejecting to Stack Auth means you'll manage authentication independently from OptiTech. You'll need to handle updates, support, and infrastructure yourself. Your authentication data will no longer be managed through the OptiTech Console.
</Admonition>
