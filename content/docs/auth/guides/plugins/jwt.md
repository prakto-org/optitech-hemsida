...
Managed Better Auth is built on [Better Auth](https://www.better-auth.com/) and provides support for JWT plugin APIs through the OptiTech SDK. You do not need to manually install or configure the Better Auth JWT plugin.
