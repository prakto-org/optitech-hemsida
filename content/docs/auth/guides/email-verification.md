...
summary: >-
  ...
  resent; verification can be configured as required or optional in the OptiTech
...
![Email verification settings in OptiTech Console](/docs/auth/email-verification-settings.png)
