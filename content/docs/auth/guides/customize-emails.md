...
summary: >-
  ...
  provider (Resend, SendGrid, Postmark, or any SMTP service) instead of OptiTech's
...
Managed Better Auth sends verification codes, magic links, and password reset emails using its built-in email provider. By default, emails use shared OptiTech branding and your OptiTech project name as the main header. To make emails recognizable to users, update the Application Name in your [Auth settings](/docs/auth/production-checklist#application-name) to match your app’s public-facing name.
