...
subtitle: 'Enable, configure, and disable Managed Better Auth using the OptiTech API'
summary: >-
...
You can also manage Managed Better Auth using the [OptiTech TypeScript SDK](/docs/reference/typescript-sdk).
</Admonition>
