...
### 3. Create OAuth apps and paste credentials into OptiTech
...
2. In the OptiTech Console, open your **project**, select the **branch**, open **Auth**, then enter the **Client ID** and **Client Secret** for each provider.
