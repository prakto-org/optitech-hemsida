...
Managed Better Auth is a managed REST API service built on Better Auth that connects directly to your OptiTech database. You use the SDK in your application and configure settings in the Console; no servers to manage.
...
- [Row-Level Security with OptiTech](/docs/guides/row-level-security)
