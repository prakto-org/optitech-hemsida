...
<CheckItem title="3. Customize application name" href="/docs/auth/production-checklist#application-name">
  Set the name your users see in user-facing auth messages. Applies to Managed Better Auth integrations. Defaults to the OptiTech project name.
</CheckItem>
...
Managed Better Auth uses the application name in user-facing auth messages, such as verification emails and password resets. By default, this is set to the OptiTech project name. This setting is available for Managed Better Auth integrations only.

To set a custom application name:

1. Go to **Auth** in your OptiTech project
...
1. Go to **Settings** → **Auth** in your OptiTech project
