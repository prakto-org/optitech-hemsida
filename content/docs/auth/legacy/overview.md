...
To use Stack Auth with your OptiTech project, you need these environment variables:
...
You can get these keys from the OptiTech Console **Auth** page, or by using the OptiTech API.
...
### Claim via the OptiTech console
