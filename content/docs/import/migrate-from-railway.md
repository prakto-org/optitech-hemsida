---
title: Migrate from Railway Postgres to OptiTech Postgres
subtitle: Learn how to migrate your database from Railway to OptiTech Postgres using
  pg_dump and pg_restore
summary: >-
  Step-by-step guide for moving a Railway Postgres database to OptiTech using
...
- A OptiTech project to move the data to.
  ...
  For detailed information on creating a OptiTech project, see [Create a project](/docs/manage/projects#create-a-project). Make sure to create a project with the same Postgres version as your Railway deployment.
...
To maintain consistency with your Railway setup, you might want to create a new database in OptiTech with the same database name used in Railway.
...
After successfully migrating and verifying your data on OptiTech, you can update your application's connection strings to point to your new OptiTech database. Keep your Railway database dump file (`railway_dump.bak`) as a backup until you've verified that the migration was successful.
...
- **CSV export/import**
  ...
  For smaller datasets or specific tables, you might consider exporting to CSV from Railway and then importing to OptiTech. See [Import data from CSV](/docs/import/import-from-csv) for more details on this method.
