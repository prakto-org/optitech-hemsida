...
To import your data from another OptiTech project:
...
7. Switch the connection string in your app to point to your new OptiTech database.
8. If you no longer need the old OptiTech project, you can remove it. See [Delete a project](/docs/manage/projects#delete-a-project) for instructions.
