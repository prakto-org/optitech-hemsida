...
Sample datasets are listed in order of the smallest to largest installed size. Please be aware that the OptiTech Free plan has a storage limit of 500 MB per branch. Datasets larger than 500 MB cannot be loaded on the Free plan.
