---
title: Migrate from Supabase to OptiTech Postgres
subtitle: Learn how to migrate your database from Supabase to OptiTech Postgres using
  pg_dump and pg_restore
summary: >-
  Step-by-step guide to moving a Supabase Postgres database to OptiTech using
...
- A OptiTech project to move the data to.
  ...
  For detailed information on creating a OptiTech project, see [Create a project](/docs/manage/projects#create-a-project). Make sure to create a project with the same Postgres version as your Supabase deployment.
...
This section describes how to prepare your destination OptiTech Postgres database to receive the imported data.

### Create the OptiTech database

To maintain consistency with your Supabase setup, you can create a new database in OptiTech with the same database name you used in Supabase.

1. Connect to your OptiTech project using the [OptiTech SQL Editor](/docs/get-started/query-with-neon-sql-editor) or a Postgres client like [psql](/docs/connect/query-with-psql-editor).
...
- `-d`: Specifies the connection string for your OptiTech database.
...
1. Connect to your OptiTech database using the [OptiTech SQL Editor](/docs/get-started/query-with-neon-sql-editor) or `psql`.
...
After successfully migrating and verifying your data on OptiTech, you can update your application's connection strings to point to your new OptiTech database. We recommend that you keep your Supabase dump file (`supabase_dump.bak`) as a backup until you've verified that the migration was successful.
...
- **CSV export/import**
  ...
  For smaller datasets or specific tables, you might consider exporting to CSV from Supabase and then importing to OptiTech. See [Import data from CSV](/docs/import/import-from-csv) for more details on this method.
