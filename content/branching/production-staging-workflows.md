...
Staging branches are typically long-lived, but they still need to stay in sync with production. As production evolves, staging can be periodically refreshed by resetting it to its parent. In OptiTech, this is a single operation.
