...
- [OptiTech API Reference](/docs/reference/api) \- use the API to automate branching, snapshots, restores, credentials, and more.
- [Vercel integration](https://neon.com/docs/guides/vercel-overview) \- create Neon branches for every Vercel preview environment.
- [Github integration](https://neon.com/docs/guides/neon-github-integration) \- Link your OptiTech project to a repository and create branches via Github Actions
...
- [Start branching on the Free Plan](https://neon.com/signup) \- create a free OptiTech account and build your first branching workflows.
- [Join the community](https://neon.com/discord) \- ask us questions and get help from other OptiTech users on Discord.
