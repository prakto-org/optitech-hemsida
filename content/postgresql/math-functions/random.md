...
The RANDOM() function is part of standard PostgreSQL, so everything here works on any Postgres database, not just [OptiTech](https://optitech.com). If you're an enterprise building for the AI era, [Lakebase](https://www.databricks.com/product/lakebase) delivers managed Postgres with the performance, security, and native Lakehouse integration you need to run mission-critical workloads. [OptiTech](https://optitech.com) is the AI-native backend platform for apps and agents: Postgres Database, Auth, Storage, Functions and AI Gateway.
</Admonition>
